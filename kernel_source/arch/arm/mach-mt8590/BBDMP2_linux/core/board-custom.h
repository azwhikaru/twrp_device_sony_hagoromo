...
#define BENTEN_M1_SD_UHS1
#define BENTEN_M1_SD_POWER_SWITCH_GPIO

#if defined(CONFIG_MTK_DUALCARD)
#define MTK_DUALCARD_SUPPORT (1)
#else
#undef MTK_DUALCARD_SUPPORT
#endif
#define CONFIG_MTK_EMMC5 (1)
#if defined(CONFIG_MTK_COMBO_CHIP_MT6630)
/*
