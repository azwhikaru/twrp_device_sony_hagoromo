...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	...
	/* GPIO DEBUG LEDS */
	{"dtb:gpio:LED_RED_1",	MT65XX_LED_MODE_GPIO, GPIO54, {0}, ""},
	{"dtb:gpio:LED_GREEN_1",	MT65XX_LED_MODE_GPIO, GPIO53, {0}, ""},
	/* PWM DEBUG LEDS */
	{"dtb:pwm:LED_RED_2",	MT65XX_LED_MODE_GPIO, GPIO206, {0}, "mmc1"},
	{"dtb:pwm:LED_GREEN_2",	MT65XX_LED_MODE_GPIO, GPIO207, {0}, ""},
	/* LCD BACKLIGHT LED */
#ifdef CONFIG_BACKLIGHT_ICX_LM3630
	{"lcd-backlight",     MT65XX_LED_MODE_CUST_BLS_PWM, (int)disp_bls_set_backlight,{3,1,0,0,0}, ""},
#else
...
#else /* CUST_LEDS_HAVE_TRIGGER */
	/* GPIO DEBUG LEDS */
	{"dtb:gpio:LED_RED_1",	MT65XX_LED_MODE_GPIO, GPIO54, {0}},
	{"dtb:gpio:LED_GREEN_1",	MT65XX_LED_MODE_GPIO, GPIO53, {0}},
	/* PWM DEBUG LEDS */
	{"dtb:pwm:LED_RED_2",	MT65XX_LED_MODE_GPIO, GPIO206, {0}},
	{"dtb:pwm:LED_GREEN_2",	MT65XX_LED_MODE_GPIO, GPIO207, {0}},
	/* LCD BACKLIGHT LED */
#ifdef CONFIG_BACKLIGHT_ICX_LM3630
	{"lcd-backlight",     MT65XX_LED_MODE_CUST_BLS_PWM, (int)disp_bls_set_backlight,{3,1,0,0,0}},
