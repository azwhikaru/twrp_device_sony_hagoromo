...
#if 1 /* NVP add test */
#define PART_SIZE_PRELOADER			(256*KB)	/* 0x40000 */
#define PART_SIZE_MBR			(512*KB)	/* 0x80000 */
#define PART_SIZE_EBR1			(512*KB)	/* 0x80000 */
#define PART_SIZE_PRO_INFO			(3072*KB)	/* 0x300000 */
#define PART_SIZE_NVRAM			(5120*KB)	/* 0x500000 */
#define PART_SIZE_PROTECT_F			(10240*KB)	/* 0xA00000 */
#define PART_SIZE_PROTECT_S			(10240*KB)	/* 0xA00000 */
#define PART_SIZE_SECCFG			(128*KB)	/* 0x20000 */
#define PART_OFFSET_SECCFG			(0x1D00000)
#define PART_SIZE_UBOOT			(384*KB)	/* 0x60000 */
#define PART_SIZE_UBOOT2			(384*KB)	/* 0x60000 */
#define PART_SIZE_BOOTIMG			(16384*KB)	/* 0x1000000 */
#define PART_SIZE_BOOTIMG2			(16384*KB)	/* 0x1000000 */
#define PART_SIZE_RECOVERY			(16384*KB)	/* 0x1000000 */
#define PART_SIZE_RECOVERY2			(16384*KB)	/* 0x1000000 */
#define PART_SIZE_SEC_RO			(6144*KB)	/* 0x600000 */
#define PART_OFFSET_SEC_RO			(0x3D80000)
#define PART_SIZE_MISC			(512*KB)	/* 0x80000 */
#define PART_SIZE_LOGO			(3072*KB)	/* 0x300000 */
#define PART_SIZE_CUSTOM			(56320*KB)	/* 0x3700000 */
#define PART_SIZE_EBR2			(512*KB)	/* 0x80000 */
#define PART_SIZE_EXPDB			(10240*KB)	/* 0xA00000 */
#define PART_SIZE_TEE1			(5120*KB)	/* 0x500000 */
#define PART_SIZE_TEE2			(5120*KB)	/* 0x500000 */
#define PART_SIZE_KB			(1024*KB)	/* 0x100000 */
#define PART_SIZE_DKB			(1024*KB)	/* 0x100000 */
#define PART_SIZE_ANDROID			(614400*KB)	/* 0x25800000 */
#define PART_SIZE_CACHE			(7168*KB)	/* 0x600000 */
#define PART_SIZE_USRDATA			(40960*KB)	/* 0x2800000 */
#define PART_SIZE_CHROME			(131072*KB)	/* 0x8000000 */
#define PART_SIZE_OTP			(44032*KB)	/* 0x2B00000 */
#define PART_SIZE_EBR3			(512*KB)	/* 0x80000 */
#define PART_SIZE_NVP			(15360*KB)	/* 0xF00000 */
#define PART_SIZE_VAR			(112640*KB)	/* 0x6E00000 */
#define PART_SIZE_DB			(532480*KB)	/* 0x20800000 */
/*#define PART_SIZE_CONTENTS			(5939200*KB)*/	/* 0x16A800000 */
#define PART_SIZE_FAT			(5939200*KB)	/* 0x16A800000 */
#define PART_SIZE_BMTPOOL			(21504*KB)  /* 0x1500000 */
