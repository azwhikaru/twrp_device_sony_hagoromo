...
#define GPIO_HDMI_RX_POWER_5V_STATUS_PIN         (GPIO24 | 0x80000000)
#define GPIO_HDMI_RX_POWER_5V_STATUS_PIN_M_GPIO   GPIO_MODE_00
#define GPIO_HDMI_RX_POWER_5V_STATUS_PIN_M_KCOL   GPIO_MODE_03
#define GPIO_HDMI_RX_POWER_5V_STATUS_PIN_M_EINT   GPIO_HDMI_RX_POWER_5V_STATUS_PIN_M_GPIO

#define GPIO_WIFI_LDO_EN_PIN         (GPIO26 | 0x80000000)
#define GPIO_WIFI_LDO_EN_PIN_M_GPIO   GPIO_MODE_00
#define GPIO_WIFI_LDO_EN_PIN_M_KROW   GPIO_MODE_03
#define GPIO_WIFI_LDO_EN_PIN_M_EINT   GPIO_WIFI_LDO_EN_PIN_M_GPIO
...
#define GPIO_KPD_KROW1_PIN         (GPIO102 | 0x80000000)
#define GPIO_KPD_KROW1_PIN_M_GPIO   GPIO_MODE_00
#define GPIO_KPD_KROW1_PIN_M_KROW   GPIO_MODE_04

#define GPIO_KPD_KROW2_PIN         (GPIO103 | 0x80000000)
#define GPIO_KPD_KROW2_PIN_M_GPIO   GPIO_MODE_00
#define GPIO_KPD_KROW2_PIN_M_KROW   GPIO_MODE_04

#define GPIO_KPD_KROW3_PIN         (GPIO104 | 0x80000000)
#define GPIO_KPD_KROW3_PIN_M_GPIO   GPIO_MODE_00
#define GPIO_KPD_KROW3_PIN_M_KROW   GPIO_MODE_04

#define GPIO_KPD_KCOL3_PIN         (GPIO199 | 0x80000000)
...
#define GPIO_WIFI_PMU_EN_PIN         (GPIO240 | 0x80000000)
#define GPIO_WIFI_PMU_EN_PIN_M_GPIO   GPIO_MODE_00

#define GPIO_WIFI_RST_PIN         (GPIO241 | 0x80000000)
