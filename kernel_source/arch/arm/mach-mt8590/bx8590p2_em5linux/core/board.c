...
struct msdc_hw msdc1_hw = {
    ...
    .flags          = MSDC_SYS_SUSPEND | MSDC_WP_PIN_EN | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_HIGHSPEED | MSDC_SDR50 | MSDC_DDR | MSDC_UHS1/* |MSDC_SD_NEED_POWER*/,
    
#else
    .flags          = MSDC_SYS_SUSPEND | MSDC_WP_PIN_EN | MSDC_HIGHSPEED/* | MSDC_SDR50 | MSDC_DDR | MSDC_UHS1*/,   
#endif
#else 
#ifdef CUST_EINT_MSDC1_INS_NUM
    .flags          = MSDC_SYS_SUSPEND | MSDC_WP_PIN_EN | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_HIGHSPEED/* |MSDC_SDR50 | MSDC_DDR | MSDC_UHS1 |MSDC_SD_NEED_POWER*/,
