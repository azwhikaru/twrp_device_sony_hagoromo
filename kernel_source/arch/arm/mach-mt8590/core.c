...
static struct map_desc mt_io_desc[] __initdata = 
{
    ...
    {
        .virtual = HIFSYS_SYSCTL_BASE,
        .pfn = __phys_to_pfn(IO_VIRT_TO_PHYS(HIFSYS_SYSCTL_BASE)),
        .length = SZ_4K,
        .type = MT_DEVICE
    },
    {
        .virtual = ETHDMASYS_SYSCTL_BASE,
        .pfn = __phys_to_pfn(IO_VIRT_TO_PHYS(ETHDMASYS_SYSCTL_BASE)),
        .length = SZ_4K,
        .type = MT_DEVICE
    },
    {
        .virtual = ETH_FRAME_ENG_BASE,
        .pfn = __phys_to_pfn(IO_VIRT_TO_PHYS(ETH_FRAME_ENG_BASE)),
        .length = SZ_16K,
        .type = MT_DEVICE
    },
    {
        .virtual = ETH_GMAC_BASE,
        .pfn = __phys_to_pfn(IO_VIRT_TO_PHYS(ETH_GMAC_BASE)),
        .length = SZ_4K,
        .type = MT_DEVICE
    },
#if 1
