...
#define ABORT_EMI_BUS_INTERFACE 0x02000000 //DEVAPC0_D0_VIO_STA_0, idx:25
#define ABORT_EMI               0x00000020 //DEVAPC0_D0_VIO_STA_3, idx:133
#define TIMEOUT 100
...
static irqreturn_t mpu_violation_irq(int irq, void *dev_id)
{
    ...
    if ((readl(IOMEM(DEVAPC0_D0_VIO_STA_0)) & ABORT_EMI_BUS_INTERFACE) == 0 
        && (readl(IOMEM(DEVAPC0_D0_VIO_STA_4)) & ABORT_EMI) == 0) {
#ifdef CONFIG_ARCH_MT8590_ICX
	/* reducing busy debug logs */
#else /* CONFIG_ARCH_MP8590_ICX */
        printk(KERN_INFO "Not EMI MPU violation.\n");
#endif /* CONFIG_ARCH_MP8590_ICX */
        return IRQ_NONE;
    }
    ...
    {
        mt65xx_reg_sync_writel(ABORT_EMI, DEVAPC0_D0_VIO_STA_4);
    }
