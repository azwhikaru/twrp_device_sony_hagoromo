...
/*for support driect eint*/
extern void mt_deint_registration(unsigned int deint_num, unsigned int flag,
...
extern void mt_eint_snap_status_icx(struct icx_pm_helper_spm_stat *sps);
