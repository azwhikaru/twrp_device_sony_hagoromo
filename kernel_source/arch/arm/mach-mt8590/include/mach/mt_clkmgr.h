...
/* clkmgr constants */
/* DISP SYS in MT8127 - MMSYS in MT8590 */
...
enum cg_clk_id {
	...
	MT_CG_PERI_MSDC30_3,
	MT_CG_PERI_MSDC30_4,
	MT_CG_PERI_EMMC_HCLK = MT_CG_PERI_MSDC30_4,
	MT_CG_PERI_NLI,
	MT_CG_PERI_UART0,
	MT_CG_PERI_UART1,
	MT_CG_PERI_UART2,
	...
	/* FIXME: 
	 * camera module is removed from img sys,
	 * but code driver is still builded.
	 * keep these camera-related macros for building pass.
	 */
	/* IMAGE - CG_IMAGE */
	MT_CG_IMAGE_LARB2_SMI,
	MT_CG_IMAGE_RESZ,
	MT_CG_IMAGE_CAM_SMI,
	MT_CG_IMAGE_JPGDEC = MT_CG_IMAGE_CAM_SMI,
	MT_CG_IMAGE_CAM_CAM,
	MT_CG_IMAGE_SEN_TG,
	MT_CG_IMAGE_SEN_CAM,
	MT_CG_IMAGE_VENC_LT = MT_CG_IMAGE_SEN_CAM,
	MT_CG_IMAGE_VENC_JPENC,
	MT_CG_IMAGE_VENC = MT_CG_IMAGE_VENC_JPENC,
	...
	MT_CG_AUDIO_HDMIRX = MT_CG_AUDIO_MULTI_IN,
	MT_CG_AUDIO_INTDIR,
	MT_CG_AUDIO_A1SYS,
	MT_CG_AUDIO_A2SYS,
...
enum {
	...
	/* CLK_CFG_5 (dpilvds is not used) */
	MT_MUX_DPILVDS,
	MT_MUX_APLL,
	MT_MUX_HDMI,
	MT_MUX_TVE,

	/* CLK_CFG_6 (eth_50m is not used) */
	MT_MUX_EMMC_HCLK,
	MT_MUX_ETH_50M,
	MT_MUX_NFI2X,
	MT_MUX_RTC,
	...
	/* CLK_CFG_13 (host_spi is not used */
	MT_MUX_ETHIF,
	MT_MUX_MS_CARD,
	MT_MUX_HOST_SPI,
	MT_MUX_ASM_H,
...
/* AUDPLL: not used but keep it for building */
...
#define TRGPLL_CON0			(APMIXEDSYS_BASE + 0x0280)
#define TRGPLL_CON1			(APMIXEDSYS_BASE + 0x0284)
#define TRGPLL_PWR_CON0		(APMIXEDSYS_BASE + 0x028C)

#define ETHPLL_CON0			(APMIXEDSYS_BASE + 0x0290)
#define ETHPLL_CON1			(APMIXEDSYS_BASE + 0x0294)
#define ETHPLL_PWR_CON0		(APMIXEDSYS_BASE + 0x029C)

#define VDECPLL_CON0		(APMIXEDSYS_BASE + 0x02A0)
#define VDECPLL_CON1		(APMIXEDSYS_BASE + 0x02A4)
#define VDECPLL_PWR_CON0	(APMIXEDSYS_BASE + 0x02AC)

#define HADDS2PLL_CON0		(APMIXEDSYS_BASE + 0x02B0)
#define HADDS2PLL_CON1		(APMIXEDSYS_BASE + 0x02B4)
#define HADDS2PLL_PWR_CON0	(APMIXEDSYS_BASE + 0x02BC)
...
#define TVD2PLL_CON0		(APMIXEDSYS_BASE + 0x02D0)
#define TVD2PLL_CON1		(APMIXEDSYS_BASE + 0x02D4)
#define TVD2PLL_PWR_CON0	(APMIXEDSYS_BASE + 0x02DC)

/* LVDSPLL: not used but keep it for building */
...
#define BDP_DISPSYS_CG_CON0	(BDP_DISPSYS_BASE + 0x0100)
#define BDP_DISPSYS_CG_SET0	(BDP_DISPSYS_BASE + 0x0104)
#define BDP_DISPSYS_CG_CLR0	(BDP_DISPSYS_BASE + 0x0108)
#define BDP_DISPSYS_CG_CON1	(BDP_DISPSYS_BASE + 0x0110)
#define BDP_DISPSYS_CG_SET1	(BDP_DISPSYS_BASE + 0x0114)
#define BDP_DISPSYS_CG_CLR1	(BDP_DISPSYS_BASE + 0x0118)

#define HIFSYS_SYSCTL_CLKCFG1		(HIFSYS_SYSCTL_BASE + 0x0030)
#define ETHDMASYS_SYSCTL_CLKCFG1	(ETHDMASYS_SYSCTL_BASE + 0x0030)
