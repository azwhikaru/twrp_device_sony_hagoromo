...
#define MT6582_SPI0_IRQ_ID                  (GIC_PRIVATE_SIGNALS + 78)
#define MT6582_SPI1_IRQ_ID                  (GIC_PRIVATE_SIGNALS + 79)
#define MT6582_SPI2_IRQ_ID                  (GIC_PRIVATE_SIGNALS + 142)
...
#define MT_EINT_DIRECT1_IRQ_ID              (GIC_PRIVATE_SIGNALS + 122)
#define MT_EINT_DIRECT2_IRQ_ID              (GIC_PRIVATE_SIGNALS + 123)
#define MT_EINT_DIRECT3_IRQ_ID              (GIC_PRIVATE_SIGNALS + 124)
#define MT_EINT_DIRECT4_IRQ_ID              (GIC_PRIVATE_SIGNALS + 125)
#define MT_EINT_DIRECT5_IRQ_ID              (GIC_PRIVATE_SIGNALS + 126)
#define MT_EINT_DIRECT6_IRQ_ID              (GIC_PRIVATE_SIGNALS + 127)
#define MT_EINT_DIRECT7_IRQ_ID              (GIC_PRIVATE_SIGNALS + 128)
