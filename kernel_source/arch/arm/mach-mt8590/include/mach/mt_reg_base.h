...
#define HIFSYS_SYSCTL_BASE	  (0xFA000000)
#define ETHDMASYS_SYSCTL_BASE (0xFB000000)
#define ETH_FRAME_ENG_BASE    (0xFB100000)
#define ETH_GMAC_BASE         (0xFB110000)
#define ETH_GMAC_BASE         (0xFB110000)
#define BDP_DISPSYS_BASE      (0xFC000000)
