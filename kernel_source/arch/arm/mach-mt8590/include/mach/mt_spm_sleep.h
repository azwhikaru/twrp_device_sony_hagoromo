...
extern wake_reason_t spm_go_to_dpidle(bool cpu_pdn, u16 pwrlevel, u16 mode);


/*
 * for ultra-deep idle
 */
#define SPM_ULTRA_DP_ENABLED

/*
 * for ultra-deep idle
 */
#define SPM_COLD_SLEEP_ENABLED
extern wake_reason_t spm_go_to_cold_sleep(void);
