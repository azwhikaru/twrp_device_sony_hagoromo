...
X_DEFINE_IRQ(MT6582_SPI0_IRQ_ID            , 110, L,LEVEL)
X_DEFINE_IRQ(MT6582_SPI1_IRQ_ID 		   , 111, L,LEVEL)
X_DEFINE_IRQ(MT6582_SPI2_IRQ_ID            , 174, L,LEVEL)
...
X_DEFINE_IRQ(MT_VIN_IRQ_ID 			       , 137, L,LEVEL)
...
X_DEFINE_IRQ(MT_HDMIRX_IRQ_ID			   , 143, L,LEVEL)
