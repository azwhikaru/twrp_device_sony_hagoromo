...
int spm_dvfs_ctrl_volt(u32 value)
{
	...
	if (!strcmp(CONFIG_ARCH_MTK_PROJECT, "bx8590m2_emmc") ||
		!strcmp(CONFIG_ARCH_MTK_PROJECT, "bx8590m3_emmc") ||
		!strcmp(CONFIG_ARCH_MTK_PROJECT, "bx8590m3_ldvt") ||
		!strcmp(CONFIG_ARCH_MTK_PROJECT, "bx8590m2_ldvt") ||
		!strcmp(CONFIG_ARCH_MTK_PROJECT, "bx8590m2_nand") ||
		!strcmp(CONFIG_ARCH_MTK_PROJECT, "bx8590p3_linux") ||
		!strcmp(CONFIG_ARCH_MTK_PROJECT, "BBMini1_linux")) {
