...
typedef struct _CHANNEL_LIST_ONLY_BW20_T {
	UINT_8 ucChannelListIdx;
	UINT_8 ucBw20Channel[MAX_BW20_NUM];
} CHANNEL_LIST_ONLY_BW20_T, *P_CHANNEL_LIST_ONLY_BW20_T;
/*******************************************************************************
*                            P U B L I C   D A T A
********************************************************************************
*/
