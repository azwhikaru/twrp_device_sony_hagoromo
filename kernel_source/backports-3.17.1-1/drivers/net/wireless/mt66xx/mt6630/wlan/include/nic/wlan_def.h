...
#if 1
#define NVRAM_FEATURE_NORAML                           0
#define NVRAM_FEATURE_2G_ONLY_HT20                     BIT(0)
#define NVRAM_FEATURE_5G_ONLY_HT20                     BIT(1)
#define NVRAM_FEATURE_DISABLE_VHT                      BIT(2)
#endif
