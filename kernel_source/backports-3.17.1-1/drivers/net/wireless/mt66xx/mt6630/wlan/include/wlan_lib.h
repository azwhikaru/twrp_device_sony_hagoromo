...
#define SINGLE_SKU_V2
#define DOT11_VHT_AC
#define CUSTOMIZE_SINGLE_SKU_V2
...
#endif
#define SINGLE_SKU_TABLE_FILE_NAME "/etc/MT6630L_SingleSKU_000.dat"
...
#if 1
	UINT_8 ucTxMaxPwrForCE_CCK;
	UINT_8 ucTxMaxPwrForCE_OFDM;
	UINT_8 ucTxMaxPwrForCE_HT20;
	UINT_8 ucTxMaxPwrForCE_HT40;
	UINT_8 auc5GChOffset[13];
	UINT_8 ucFreqoffset;
	UINT_8 ucFeatureEnable;
	UINT_8 ucCountryListIndex;
	UINT_8 ucSingleSKUNumber;
	UINT_8 aucreserved;
#endif
...
#define MAX_AUTO_SCAN_CHAN_NUM				    32	
...
/* Record Each CH Load */
typedef struct _PARAM_SCAN_CHN_LOAD_INFO {
    /* Per-CHN Load */
	UINT_32 u4Flag;
	
	UINT_8 	ucChannel;
	UINT_16 u2Freq;
	UINT_16 u2DirtyScore;
    ...
    /* Reserved fields */
    UINT_8  au4Reserved1[8];
} PARAM_SCAN_CHN_LOAD_INFO, *P_PARAM_SCAN_CHN_LOAD_INFO;

typedef struct _PARAM_GET_CHN_LOAD {
	LTE_SAFE_CH_INFO_T 	rLteSafeChnList;
	PARAM_CHN_LOAD_INFO rEachChnLoad[MAX_AUTO_CHAL_NUM];
	PARAM_SCAN_CHN_LOAD_INFO rScanChnLoad[MAX_AUTO_SCAN_CHAN_NUM];
	UINT_32 u4ScanChnNum;
...
typedef struct _PARAM_PREFER_CHN_INFO_EXT {	
	UINT_8 	ucChannel;
	UINT_32 u4Freq;
	UINT_16	u2APNumScore;
    UINT_8  au4Reserved1[1];
} PARAM_PREFER_CHN_INFO_EXT, *P_PARAM_PREFER_CHN_INFO_EXT;
...
#endif  //End of #if CFG_AUTO_CHANNEL_SEL_SUPPORT
