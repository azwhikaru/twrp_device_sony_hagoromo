...
*/
/*----------------------------------------------------------------------------*/
WLAN_STATUS nicUpdateTxPowerV2(IN P_ADAPTER_T prAdapter, IN P_CMD_TX_PWR_T prTxPwrParam)
{
#if 1

	P_CMD_TX_PWR_V2_T prTxPwrV2; 
	P_CMD_TX_PWR_T 		prTxPwr;
	UINT_8			i;
	...
	prTxPwrV2 = (P_PARAM_PMKID_T) kalMemAlloc(8 + sizeof(CMD_TX_PWR_V2_T), VIR_MEM_TYPE);
	kalMemZero(prTxPwrV2,8 + sizeof(CMD_TX_PWR_V2_T));

#if 0


	prTxPwrV2->ucChannelNum = 2;
	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))->ucChannel = 6;
	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))->rTxPwrV2ByChannel.cTxPwr2G4Cck = 9;
	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))->rTxPwrV2ByChannel.cTxPwr2G4HT40_MCS7 = 5;
	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))->rTxAcPwr.c11AcTxPwr_BPSK = 4;
	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))->rTxAcPwr.c11AcTxPwrVht160_OFFSET = 3;
	
	

	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))+1))->ucChannel = 7;
	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))+1))->rTxPwrV2ByChannel.cTxPwr2G4Cck = 8;
	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))+1))->rTxPwrV2ByChannel.cTxPwr2G4HT40_MCS7 = 9;
	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))+1))->rTxAcPwr.c11AcTxPwr_BPSK = 10;
	((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))+1))->rTxAcPwr.c11AcTxPwrVht160_OFFSET = 11;

	printk("[PWR] suppertank need buffer =%d\n", sizeof(CMD_TX_PWR_V2_BY_CHANNEL_T));
#endif
#if 1
	prTxPwrV2->ucChannelNum = 0;

	for (i=0 ; i<56; i ++) {

		prTxPwrV2->ucChannelNum ++;

		prTxPwr = &(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))+i))->rTxPwrV2ByChannel);
		
		if (TxPwrPerCh[i].Channel != 0 ) {
			((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))+i))->ucChannel = TxPwrPerCh[i].Channel;
		}

		kalMemZero(&(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(((P_CMD_TX_PWR_V2_BY_CHANNEL_T)(prTxPwrV2->aucPwrSetting))+i))->rTxAcPwr),sizeof(AC_PWR_SETTING_STRUCT));
		


		//CCK
		prTxPwr->cTxPwr2G4Cck =  TxPwrPerCh[i].TxPwr.cTxPwr2G4Cck;

		//Dsss
		prTxPwr->cTxPwr2G4Dsss =  TxPwrPerCh[i].TxPwr.cTxPwr2G4Dsss;

		if(TxPwrPerCh[i].Channel <= 14){

		

			/* OFDM */
			prTxPwr->cTxPwr2G4OFDM_BPSK = TxPwrPerCh[i].TxPwr.cTxPwr2G4OFDM_BPSK;
			prTxPwr->cTxPwr2G4OFDM_QPSK = TxPwrPerCh[i].TxPwr.cTxPwr2G4OFDM_QPSK;
			prTxPwr->cTxPwr2G4OFDM_16QAM = TxPwrPerCh[i].TxPwr.cTxPwr2G4OFDM_16QAM;
			prTxPwr->cTxPwr2G4OFDM_48Mbps = TxPwrPerCh[i].TxPwr.cTxPwr2G4OFDM_48Mbps;
			prTxPwr->cTxPwr2G4OFDM_54Mbps = TxPwrPerCh[i].TxPwr.cTxPwr2G4OFDM_54Mbps;

			/*HT20 */
			prTxPwr->cTxPwr2G4HT20_BPSK = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT20_BPSK;
			prTxPwr->cTxPwr2G4HT20_QPSK = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT20_QPSK;
			prTxPwr->cTxPwr2G4HT20_16QAM = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT20_16QAM;
			prTxPwr->cTxPwr2G4HT20_MCS5 = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT20_MCS5;
			prTxPwr->cTxPwr2G4HT20_MCS6 = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT20_MCS6;
			prTxPwr->cTxPwr2G4HT20_MCS7 = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT20_MCS7;

			/*HT40 */
			prTxPwr->cTxPwr2G4HT40_BPSK = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT40_BPSK;
			prTxPwr->cTxPwr2G4HT40_QPSK = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT40_QPSK;
			prTxPwr->cTxPwr2G4HT40_16QAM = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT40_16QAM;
			prTxPwr->cTxPwr2G4HT40_MCS5 = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT40_MCS5;
			prTxPwr->cTxPwr2G4HT40_MCS6 = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT40_MCS6;
			prTxPwr->cTxPwr2G4HT40_MCS7 = TxPwrPerCh[i].TxPwr.cTxPwr2G4HT40_MCS7;
			
		}else{

			/* OFDM */
			prTxPwr->cTxPwr5GOFDM_BPSK = TxPwrPerCh[i].TxPwr.cTxPwr5GOFDM_BPSK;
			prTxPwr->cTxPwr5GOFDM_QPSK = TxPwrPerCh[i].TxPwr.cTxPwr5GOFDM_QPSK;
			prTxPwr->cTxPwr5GOFDM_16QAM = TxPwrPerCh[i].TxPwr.cTxPwr5GOFDM_16QAM;
			prTxPwr->cTxPwr5GOFDM_48Mbps = TxPwrPerCh[i].TxPwr.cTxPwr5GOFDM_48Mbps;
			prTxPwr->cTxPwr5GOFDM_54Mbps = TxPwrPerCh[i].TxPwr.cTxPwr5GOFDM_54Mbps;

			/*HT20 */
			prTxPwr->cTxPwr5GHT20_BPSK = TxPwrPerCh[i].TxPwr.cTxPwr5GHT20_BPSK;
			prTxPwr->cTxPwr5GHT20_QPSK = TxPwrPerCh[i].TxPwr.cTxPwr5GHT20_QPSK;
			prTxPwr->cTxPwr5GHT20_16QAM = TxPwrPerCh[i].TxPwr.cTxPwr5GHT20_16QAM;
			prTxPwr->cTxPwr5GHT20_MCS5 = TxPwrPerCh[i].TxPwr.cTxPwr5GHT20_MCS5;
			prTxPwr->cTxPwr5GHT20_MCS6 = TxPwrPerCh[i].TxPwr.cTxPwr5GHT20_MCS6;
			prTxPwr->cTxPwr5GHT20_MCS7 = TxPwrPerCh[i].TxPwr.cTxPwr5GHT20_MCS7;

			/*HT40 */
			prTxPwr->cTxPwr5GHT40_BPSK = TxPwrPerCh[i].TxPwr.cTxPwr5GHT40_BPSK;
			prTxPwr->cTxPwr5GHT40_QPSK = TxPwrPerCh[i].TxPwr.cTxPwr5GHT40_QPSK;
			prTxPwr->cTxPwr5GHT40_16QAM = TxPwrPerCh[i].TxPwr.cTxPwr5GHT40_16QAM;
			prTxPwr->cTxPwr5GHT40_MCS5 = TxPwrPerCh[i].TxPwr.cTxPwr5GHT40_MCS5;
			prTxPwr->cTxPwr5GHT40_MCS6 = TxPwrPerCh[i].TxPwr.cTxPwr5GHT40_MCS6;
			prTxPwr->cTxPwr5GHT40_MCS7 = TxPwrPerCh[i].TxPwr.cTxPwr5GHT40_MCS7;
		}
	}
#endif
	return wlanSendSetQueryCmd(prAdapter,
					   CMD_ID_SET_TX_PWR_V2,
					   TRUE,
					   FALSE,
					   FALSE,
					   NULL,
					   NULL, sizeof(CMD_TX_PWR_V2_T), (PUINT_8) prTxPwrV2, NULL, 0);
...
{
	return mtk_wcn_wmt_ic_info_get(WMTCHIN_HWVER, CHIP_TYPE_COMBO) & BITS(0, 7);
}

UINT_8 nicGetChipSwVer(VOID)
{
	return mtk_wcn_wmt_ic_info_get(WMTCHIN_FWVER, CHIP_TYPE_COMBO) & BITS(0, 7);
}

UINT_8 nicGetChipFactoryVer(VOID)
{
	return (mtk_wcn_wmt_ic_info_get(WMTCHIN_FWVER, CHIP_TYPE_COMBO) & BITS(8, 11)) >> 8;
}
