...
static struct ieee80211_channel mtk_5ghz_a_channels[] = {
	CHAN5G(34, 1), CHAN5G(36, 0),
	CHAN5G(38, 1), CHAN5G(40, 0),
	CHAN5G(42, 1), CHAN5G(44, 0),
	CHAN5G(46, 1), CHAN5G(48, 0),
	...
	CHAN5G(169, 1), CHAN5G(173, 1),
	CHAN5G(184, 1), CHAN5G(188, 1),
	CHAN5G(192, 1), CHAN5G(196, 1),
	CHAN5G(200, 1), CHAN5G(204, 1),
	CHAN5G(208, 1), CHAN5G(212, 1),
	CHAN5G(216, 1),
};
...
BOOLEAN glRegisterP2P(P_GLUE_INFO_T prGlueInfo, const char *prDevName, BOOLEAN fgIsApMode)
{
	...
	prGlueInfo->prP2PInfo->prWdev->wiphy->vendor_events = mtk_p2p_vendor_events;
	prGlueInfo->prP2PInfo->prWdev->wiphy->n_vendor_events = ARRAY_SIZE(mtk_p2p_vendor_events);
