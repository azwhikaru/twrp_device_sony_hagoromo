...
VOID glResetInit(VOID)
{
	...
	mtk_wcn_wmt_msgcb_reg(WMTDRV_TYPE_WIFI, (PF_WMT_CB) glResetCallback, CHIP_TYPE_COMBO);
...
VOID glResetUninit(VOID)
{
	...
	mtk_wcn_wmt_msgcb_unreg(WMTDRV_TYPE_WIFI, CHIP_TYPE_COMBO);
...
static void mtk_wifi_reset(struct work_struct *work)
{
	...
	wifi_reset_end_6630(rst->rst_data);
	return;
}
