...
typedef enum _CHIP_TYPE_F {
	CHIP_TYPE_SOC = 0,
	CHIP_TYPE_COMBO = 1,
	CHIP_TYPE_MAX
}CHIP_TYPE_F, *P_CHIP_TYPE_F;
...
UINT_32 mtk_wcn_wmt_ic_info_get(ENUM_WMT_CHIPINFO_TYPE_T type, CHIP_TYPE_F chip);
