...
#define CFG_SUPPORT_RX_STBC         0   /* 802.11n RX STBC (1SS) */
...
#define CFG_SUPPORT_WOWLAN                  0
#define CFG_SUPPORT_ALPS_BOX                0
#if CFG_SUPPORT_ALPS_BOX
#undef CFG_SUPPORT_WOWLAN
...
#define CFG_ENABLE_SONY_CHANNEL_TABLE        1 
#define CFG_ENABLE_SONY_CHANNEL_TABLE_DEBUG  1
#define CFG_ENABLE_DRIVER_OWN_FAIL_RESET     1 
#define DISABLE_TDLS_CHANNEL_SWITCH          1
#define HT_20_40_COEX_ALIGN_BSS              0 /* Must disable for TDLS cert*/
 ...
 *------------------------------------------------------------------------------
 */
#define CFG_SUPPORT_BENTEN_TXPWR_V2			 1  //For Benten Tx Power per Channel per Rate Setting
