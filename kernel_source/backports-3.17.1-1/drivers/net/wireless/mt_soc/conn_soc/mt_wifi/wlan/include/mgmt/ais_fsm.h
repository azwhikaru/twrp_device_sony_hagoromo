...
typedef struct _AIS_FSM_INFO_T {
    ...
    BOOLEAN             fgIsDfsJoinProcess;
    BOOLEAN             fgInformToDisableAp;
    UINT_8              ucDfsChannelSwitchCount;
    ...
    BOOLEAN             fgIsScanChanSepified;
    UINT_8              ucNumScanChannelList;
    ...
    UINT_8              aucDfsBSSID[MAC_ADDR_LEN];
	UINT_8				ucApDfsNewChan;
	OS_SYSTIME 			rDfsStartTime;
