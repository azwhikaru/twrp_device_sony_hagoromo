...
#define TDLS_LINK_HISTORY_MAX				8
...
typedef enum _TDLS_REASON_CODE {
	...
	TDLS_REASON_CODE_MTK_DIS_BY_US_DUE_TO_RX_DEAUTH = 0x8c,         /* 140 */
	TDLS_REASON_CODE_MTK_DIS_BY_US_DUE_TO_RX_TEARDOWN = 0x8d        /* 141 */
} TDLS_REASON_CODE;
...
VOID TdlsexCmdGet(P_GLUE_INFO_T prGlueInfo, UINT_8 *prInBuf, UINT_32 u4InBufLen, UINT_8 *prOutBuf, UINT_32 *pu4OutBufLen);
