        ...
        )
{
    ...
    do {
        ...
        prP2pBssInfo->fgIsProtection = FALSE;
#endif
...
#if CONFIG_MTK_BENTEN_SUPPORT		
	    //prScanReqInfo->u2PassiveDewellTime = P2P_PASSIVE_DWELL_TIME;
#endif
        // Channel List
    ...
    )
{
    ...
    do {
		...
		DBGLOG(P2P, TRACE, ("SoftAP: CurrentOPMode=%d\n", prP2pBssInfo->eCurrentOPMode));
