    ...
    )
{
    do {
        ...
        kalP2PIndicateSoftAPEnabled(prAdapter, 0);
    ...
    )
{
    ...
    P_REG_INFO_T            prRegInfo = (P_REG_INFO_T)NULL;
            ...
            case ELEM_ID_HT_CAP:    /* 45 */    /* V */
                {
                    ...
                    if ((HT_CAP_IE(pucIE)->u2HtCapInfo & HT_CAP_INFO_SHORT_GI_20M)&&(!(HT_CAP_IE(pucIE)->u2HtCapInfo & HT_CAP_INFO_SHORT_GI_40M))) {
                         DBGLOG(P2P, TRACE, ("enable soft-ap with HT20 only\n"));
                         prRegInfo->ucFeatureEnable = 3;
                    }
