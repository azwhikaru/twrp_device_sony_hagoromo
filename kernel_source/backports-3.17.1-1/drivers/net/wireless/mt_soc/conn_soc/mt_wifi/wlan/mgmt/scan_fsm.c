    ...
    )
{
    ...
    do {
        ...
        case SCAN_STATE_SCANNING:
			DBGLOG(SCN, INFO, ("SCAN_STATE_SCANNING\n"));
    ...
    )
{
    ...
    ASSERT(prAdapter);
	DBGLOG(SCN, INFO, ("scnSendScanReq\n"));

    prScanInfo = &(prAdapter->rWifiVar.rScanInfo);
    prScanParam = &prScanInfo->rScanParam;
	DBGLOG(SCN, INFO, ("prepare CmdScanReq\n"));
	...
	DBGLOG(SCN, INFO, ("Send Scan command to FW\n"));
    ...
    )
{
    ...
    prScanInfo = &(prAdapter->rWifiVar.rScanInfo);
    prScanParam = &prScanInfo->rScanParam;
	DBGLOG(SCN, INFO, ("SCAN DONE event...\n"));
