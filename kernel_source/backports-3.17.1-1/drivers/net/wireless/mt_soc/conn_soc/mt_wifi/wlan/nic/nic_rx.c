...
#define TXM_WEIGHTING_AVG4(y, x) \
        ( (UINT_8) ((( ((UINT_16)((3) * (y))) + ((UINT_16)(x))) ) >> 2))
...
#endif
		prStaRec->ucRCPI = TXM_WEIGHTING_AVG4(prStaRec->ucRCPI, prHifRxHdr->ucRcpi);
