...
static const struct iw_priv_args rIwPrivTable[] = {
    ...
    {IOCTL_SET_INTS,			IW_PRIV_TYPE_INT | 32, 0,						""},
#endif
	...
	{IOCTL_GET_STR, 			IW_PRIV_TYPE_CHAR | 256, IW_PRIV_TYPE_CHAR | 1024, ""},
    ...
    {PRIV_CMD_ACCESS_MCR_LINUX, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 3, 0,   "set_mcr_linux" },
#endif
    ...
    {PRIV_CMD_TEST_CMD_LINUX,    IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 3, 0,  "set_test_linux" },
#endif
#if CONFIG_MTK_BENTEN_SUPPORT
	{PRIV_CMD_AP_BSSID,	 IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 3, 0,          "set_ap_bssid" },

#if CFG_SOFTAP_DFS_SUPPORT
    {PRIV_CMD_RADAR_DETECT,      IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1, 0,  "set_radar_det" },
    {PRIV_CMD_RADAR_DETECT,      0, IW_PRIV_TYPE_INT | IW_PRIV_SIZE_FIXED | 1,  "get_radar_det" },    
#endif

#if CFG_SCAN_CHAN_LIST_SUPPORT
    {PRIV_CMD_SCAN_CHAN_LIST,    IW_PRIV_TYPE_INT | 32, 0,                       "set_scan_chan" },
#endif
    {PRIV_CMD_GET_CH_CAP,		 IW_PRIV_TYPE_CHAR | 256, IW_PRIV_TYPE_CHAR | 1024, "get_ch_cap"},

#endif
	/* handle any command with many input parameters */
	{PRIV_CMD_OTHER,			IW_PRIV_TYPE_CHAR | 256, 0,   "set_str_cmd"},
	{PRIV_CMD_OTHER_GET,		IW_PRIV_TYPE_CHAR | 256, IW_PRIV_TYPE_CHAR | 1024, "get_str_cmd"},
    ...
    )
{
    ...
    if (rStatus == WLAN_STATUS_INVALID_LENGTH) {
        ...
        */
    	...
    	ret = -EAGAIN; /* currently is scanning now, tell iwlist wait a minutes. */
		goto error;
    }
#endif
