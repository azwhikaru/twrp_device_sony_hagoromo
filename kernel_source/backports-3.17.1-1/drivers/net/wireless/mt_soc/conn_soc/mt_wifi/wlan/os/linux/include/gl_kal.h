...
typedef enum _KAL_CMD_GET_ID {
	KAL_CMD_GET_RSSI = 0x00,
	KAL_CMD_GET_LINKSPEED	= 0x01,
} KAL_CMD_GET_ID;

typedef struct _KAL_CMD_GET_CORE_T {
	UINT_8	aucPeerMac[6];
	UINT_8	ucNetTypeIndex;
	PCHAR	pucStr;		/* output the str */
	UINT_32	*pu4StrLen;	/* output the strlen */
} KAL_CMD_GET_CORE_T;
...
#define SONY_OUI 0x0013A9

typedef enum {
	VENDOR_EVENT_RESERVE_0,
	VENDOR_EVENT_ENABLE_SOFTAP_DONE,
	VENDOR_EVENT_RADAR_DETECT,
} WIFI_VENDOR_EVENT;
#endif
...
#define OID_ERROR_LOGFUNC(_Fmt...)
#define OID_WARN_LOGFUNC(_Fmt...)
#define OID_INFO_LOGFUNC(_Fmt...)
#define OID_STATE_LOGFUNC(_Fmt...)
#define OID_EVENT_LOGFUNC(_Fmt...)
#define OID_TRACE_LOGFUNC(_Fmt...)
#define OID_LOUD_LOGFUNC(_Fmt...)
#define OID_TEMP_LOGFUNC(_Fmt...)

#define OID_ERROR_LOGDUMP8(x, y)
#define OID_WARN_LOGDUMP8(x, y)
#define OID_INFO_LOGDUMP8(x, y)
#define OID_STATE_LOGDUMP8(x, y)
#define OID_EVENT_LOGDUMP8(x, y)
#define OID_TRACE_LOGDUMP8(x, y)
#define OID_LOUD_LOGDUMP8(x, y)
#define OID_TEMP_LOGDUMP8(x, y)
