...
#define PRIV_CMD_TEST_CMD_LINUX			32
#endif

#define PRIV_CMD_OTHER					33
/* other set string command ID */
#define PRIV_CMD_OTHER_TAR				0x01 /* TX auto rate */

#define PRIV_CMD_OTHER_GET				34
/* other get string command ID */
#define PRIV_CMD_OTHER_GET_STAREC		0x00
#define PRIV_CMD_OTHER_GET_TDLS			0x01

#if CONFIG_MTK_BENTEN_SUPPORT
#define PRIV_CMD_AP_BSSID				35
#if CFG_SOFTAP_DFS_SUPPORT
#define PRIV_CMD_RADAR_DETECT           36
#endif
#if CFG_SCAN_CHAN_LIST_SUPPORT
#define PRIV_CMD_SCAN_CHAN_LIST         37
#endif
#define PRIV_CMD_GET_CH_CAP             38
#endif

#define PRIV_CMD_ACCESS_MCR_LINUX       39
