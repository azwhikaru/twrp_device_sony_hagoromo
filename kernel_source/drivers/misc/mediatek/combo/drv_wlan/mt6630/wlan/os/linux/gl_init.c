...
bailout:
		...
		prGlueInfo->main_thread =
		    kthread_run(tx_thread, prGlueInfo->prDevHandler, "6630_tx_thread");
#if CFG_SUPPORT_MULTITHREAD
		prGlueInfo->hif_thread =
		    kthread_run(hif_thread, prGlueInfo->prDevHandler, "6630_hif_thread");
		prGlueInfo->rx_thread =
		    kthread_run(rx_thread, prGlueInfo->prDevHandler, "6630_rx_thread");
#endif
