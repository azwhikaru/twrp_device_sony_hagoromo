...
extern void register_set_p2p_mode_handler_6630(set_p2p_mode handler, struct net_device *netdev);
extern void register_set_dbg_level_handler_6630(set_dbg_level handler);
#endif
