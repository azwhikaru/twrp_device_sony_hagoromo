...
*  chipType       [IN]        chip type soc or combo
* RETURNS
*  UINT32    = 0: OK
*****************************************************************************/
...
*****************************************************************************/
extern INT32 mtk_wcn_stp_send_data(const PUINT8 buffer, const UINT32 length, const UINT8 type, CHIP_TYPE_F chipType);
...
*  INT32    >= 0: length transmitted; < 0: error
*****************************************************************************/
extern INT32 mtk_wcn_stp_send_data_raw(const PUINT8 buffer, const UINT32 length, const UINT8 type, CHIP_TYPE_F chipType);
...
*  void
*****************************************************************************/
extern INT32 mtk_wcn_stp_parser_data(PUINT8 buffer, UINT32 length, CHIP_TYPE_F chipType);
...
*****************************************************************************/
extern INT32 mtk_wcn_stp_receive_data(PUINT8 buffer, UINT32 length, UINT8 type, CHIP_TYPE_F chipType);
...
*****************************************************************************/
extern MTK_WCN_BOOL mtk_wcn_stp_is_rxqueue_empty(UINT8 type, CHIP_TYPE_F chipType);
...
*****************************************************************************/
extern MTK_WCN_BOOL mtk_wcn_stp_is_ready(CHIP_TYPE_F chipType);
...
*  void
*****************************************************************************/
extern void mtk_wcn_stp_set_bluez(MTK_WCN_BOOL flags, CHIP_TYPE_F chipType);
...
*****************************************************************************/
extern INT32 mtk_wcn_stp_register_if_tx(ENUM_STP_TX_IF_TYPE stp_if, MTK_WCN_STP_IF_TX func, CHIP_TYPE_F chipType);
...
*  INT32: 0:successful , -1: fail
*****************************************************************************/
extern INT32 mtk_wcn_stp_register_if_rx(MTK_WCN_STP_IF_RX func, CHIP_TYPE_F chipType);
...
*  INT32: 0:successful , -1: fail
*****************************************************************************/
extern INT32 mtk_wcn_stp_register_event_cb(INT32 type, MTK_WCN_STP_EVENT_CB func, CHIP_TYPE_F chipType);
...
*  INT32: 0:successful , -1: fail
*****************************************************************************/
extern INT32 mtk_wcn_stp_register_tx_event_cb(INT32 type, MTK_WCN_STP_EVENT_CB func, CHIP_TYPE_F chipType);
...
*****************************************************************************/
extern INT32 mtk_wcn_stp_coredump_start_get(CHIP_TYPE_F chipType);
...
*****************************************************************************/
extern MTK_WCN_BOOL mtk_wcn_wmt_func_off (ENUM_WMTDRV_TYPE_T type, CHIP_TYPE_F chipType);
...
*  MTK_WCN_BOOL_TRUE: OK; MTK_WCN_BOOL_FALSE:error
*****************************************************************************/
extern MTK_WCN_BOOL mtk_wcn_wmt_func_on (ENUM_WMTDRV_TYPE_T type, CHIP_TYPE_F chipType);
...
*****************************************************************************/
extern INT8 mtk_wcn_wmt_therm_ctrl (ENUM_WMTTHERM_TYPE_T eType, CHIP_TYPE_F chipType);
...
*****************************************************************************/
extern ENUM_WMTHWVER_TYPE_T mtk_wcn_wmt_hwver_get (CHIP_TYPE_F chipType);
...
*  MTK_WCN_BOOL_TRUE: OK; MTK_WCN_BOOL_FALSE:error
*****************************************************************************/
extern MTK_WCN_BOOL mtk_wcn_wmt_dsns_ctrl (ENUM_WMTDSNS_TYPE_T eType, CHIP_TYPE_F chipType);
...
*  1: OK; 0:error
*****************************************************************************/
extern INT32 mtk_wcn_wmt_msgcb_reg (ENUM_WMTDRV_TYPE_T eType,PF_WMT_CB pCb, CHIP_TYPE_F chipType);
...
*  1: OK; 0:error
*****************************************************************************/
extern INT32 mtk_wcn_wmt_msgcb_unreg (ENUM_WMTDRV_TYPE_T eType, CHIP_TYPE_F chipType);
...
*  always return 0;
*****************************************************************************/
extern INT32 mtk_wcn_stp_wmt_sdio_op_reg (PF_WMT_SDIO_PSOP own_cb, CHIP_TYPE_F chipType);
...
*  always return 0;
*****************************************************************************/
extern INT32 mtk_wcn_stp_wmt_sdio_host_awake(CHIP_TYPE_F chipType);
...
*  MTK_WCN_BOOL_TRUE: OK; MTK_WCN_BOOL_FALSE:error
*****************************************************************************/
extern MTK_WCN_BOOL mtk_wcn_wmt_assert (ENUM_WMTDRV_TYPE_T type,UINT32 reason, CHIP_TYPE_F chipType);
