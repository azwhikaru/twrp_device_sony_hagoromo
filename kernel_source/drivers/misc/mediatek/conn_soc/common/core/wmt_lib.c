...
wmt_lib_init (VOID)
{
    ...
    osal_strncpy(pThraed->threadName, "mtk_wmtd_a", sizeof(pThraed->threadName));
    ...
    )
{
    ...
    if ((0 != mtk_wcn_stp_coredump_start_get(CHIP_TYPE_SOC)) && (action == SLEEP))
    {
...
MTK_WCN_BOOL wmt_lib_put_act_op (P_OSAL_OP pOp)
{
    ...
    do {
        ...
        if((0 != mtk_wcn_stp_coredump_start_get(CHIP_TYPE_SOC)) &&\
