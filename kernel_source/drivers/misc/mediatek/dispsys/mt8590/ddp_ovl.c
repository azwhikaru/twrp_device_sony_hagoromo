...
#endif
/*
 Display Rotate (180 degree)
 #define ENABLE_DISPLAY_ROTATE
*/
...
*/
    ...
    switch(layer) {
        case 0:
...
#ifdef ENABLE_DISPLAY_ROTATE
            DISP_REG_SET_FIELD(L0_CON_FLD_VIRTICAL_FLIP, DISP_REG_OVL_L0_CON, 1);
            DISP_REG_SET_FIELD(L0_CON_FLD_HORI_FLIP, DISP_REG_OVL_L0_CON, 1);
#endif
            ...
            bg_w = bg_h & 0xFFFF;
            bg_h = bg_h >> 16;
            DISP_REG_SET(DISP_REG_OVL_L0_OFFSET, (bg_h-dst_h-dst_y)<<16 | (bg_w-dst_w-dst_x));

            offset = (src_x+dst_w+1)*bpp + (src_y+dst_h-1)*src_pitch - 1;
            DISP_REG_SET(DISP_REG_OVL_L0_ADDR, addr+offset);
#else
        ...
        case 1:
...
#ifdef ENABLE_DISPLAY_ROTATE
            DISP_REG_SET_FIELD(L1_CON_FLD_VIRTICAL_FLIP, DISP_REG_OVL_L1_CON, 1);
            DISP_REG_SET_FIELD(L1_CON_FLD_HORI_FLIP, DISP_REG_OVL_L1_CON, 1);
#endif
            ...
            bg_w = bg_h & 0xFFFF;
            bg_h = bg_h >> 16;
            DISP_REG_SET(DISP_REG_OVL_L1_OFFSET, (bg_h-dst_h-dst_y)<<16 | (bg_w-dst_w-dst_x));

            offset = (src_x+dst_w+1)*bpp + (src_y+dst_h-1)*src_pitch - 1;
            DISP_REG_SET(DISP_REG_OVL_L1_ADDR, addr+offset);
#else
        ...
        case 2:
...
#ifdef ENABLE_DISPLAY_ROTATE
            DISP_REG_SET_FIELD(L2_CON_FLD_VIRTICAL_FLIP, DISP_REG_OVL_L2_CON, 1);
            DISP_REG_SET_FIELD(L2_CON_FLD_HORI_FLIP, DISP_REG_OVL_L2_CON, 1);
#endif
            ...
            bg_w = bg_h & 0xFFFF;
            bg_h = bg_h >> 16;
            DISP_REG_SET(DISP_REG_OVL_L2_OFFSET, (bg_h-dst_h-dst_y)<<16 | (bg_w-dst_w-dst_x));

            offset = (src_x+dst_w+1)*bpp + (src_y+dst_h-1)*src_pitch - 1;
            DISP_REG_SET(DISP_REG_OVL_L2_ADDR, addr+offset);
#else
        ...
        case 3:
...
#ifdef ENABLE_DISPLAY_ROTATE
            DISP_REG_SET_FIELD(L3_CON_FLD_VIRTICAL_FLIP, DISP_REG_OVL_L3_CON, 1);
            DISP_REG_SET_FIELD(L3_CON_FLD_HORI_FLIP, DISP_REG_OVL_L3_CON, 1);
#endif
            ...
            bg_w = bg_h & 0xFFFF;
            bg_h = bg_h >> 16;
            DISP_REG_SET(DISP_REG_OVL_L3_OFFSET, (bg_h-dst_h-dst_y)<<16 | (bg_w-dst_w-dst_x));

            offset = (src_x+dst_w+1)*bpp + (src_y+dst_h-1)*src_pitch - 1;
            DISP_REG_SET(DISP_REG_OVL_L3_ADDR, addr+offset);
#else
