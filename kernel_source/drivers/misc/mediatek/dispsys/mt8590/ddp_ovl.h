...
#define L0_CON_FLD_HORI_FLIP                                    REG_FLD(1, 10)
#define L0_CON_FLD_VIRTICAL_FLIP                               REG_FLD(1, 9)
...
#define L1_CON_FLD_HORI_FLIP                                    REG_FLD(1, 10)
#define L1_CON_FLD_VIRTICAL_FLIP                               REG_FLD(1, 9)
...
#define L2_CON_FLD_HORI_FLIP                                    REG_FLD(1, 10)
#define L2_CON_FLD_VIRTICAL_FLIP                               REG_FLD(1, 9)
...
#define L3_CON_FLD_HORI_FLIP                                    REG_FLD(1, 10)
#define L3_CON_FLD_VIRTICAL_FLIP                               REG_FLD(1, 9)
