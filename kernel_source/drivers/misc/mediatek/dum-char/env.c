...
#ifdef CONFIG_MTK_EMMC5
	reval = eMMC_rw_x((loff_t) env_addr, (u32 *) env_buf, 3, 1, CFG_ENV_SIZE, 1, EMMC_PART_USER);
#else
	reval = eMMC_rw_x((loff_t) env_addr, (u32 *) env_buf, 0, 1, CFG_ENV_SIZE, 1, EMMC_PART_USER);
#endif
#else
#ifdef CONFIG_MTK_EMMC5
	reval = eMMC_rw_x((loff_t) env_addr, (u32 *) env_buf, 3, 1, CFG_ENV_SIZE, 1, USER);
#else
...
#ifdef CONFIG_MTK_NEW_COMBO_EMMC_SUPPORT
#ifdef CONFIG_MTK_EMMC5
	reval = eMMC_rw_x((loff_t) env_addr, (u32 *) env_buf, 3, 0, CFG_ENV_SIZE, 1, EMMC_PART_USER);
#else
	reval = eMMC_rw_x((loff_t) env_addr, (u32 *) env_buf, 0, 0, CFG_ENV_SIZE, 1, EMMC_PART_USER);
#endif
#else
#ifdef CONFIG_MTK_EMMC5
	reval = eMMC_rw_x((loff_t) env_addr, (u32 *) env_buf, 3, 0, CFG_ENV_SIZE, 1, USER);
#else
