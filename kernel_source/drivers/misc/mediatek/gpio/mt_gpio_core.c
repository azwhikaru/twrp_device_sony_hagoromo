...
extern void icx_startup_init(struct device_driver *driver);
extern void icx_startup_exit(struct device_driver *driver);
#endif
/*---------------------------------------------------------------------------*/
...
#ifdef CONFIG_ICX_STARTUP
    icx_startup_init(&gpio_driver.driver);
#endif
	return ret;
}
...
{
#ifdef CONFIG_ICX_STARTUP
    icx_startup_exit(&gpio_driver.driver);
#endif
