...
enum HDMI_AVI_INFO_RATIO {
	HDMI_AVI_RATIO_4_3,
	HDMI_AVI_RATIO_16_9
};

struct HDMI_HDCP_SRM {
	unsigned char srm_buf[5120];
};
...
#define MTK_HDMI_GET_EDID_SEGMENT               HDMI_IOWR(97, HDMITX_EDID_SEGMENT)
#define MTK_HDMI_SET_AVI_RATIO					HDMI_IOWR(98, enum HDMI_AVI_INFO_RATIO)
#define MTK_HDMI_HDCP_SET_SRM					HDMI_IOWR(99, struct HDMI_HDCP_SRM)
#define MTK_HDMI_TMDS_ON_OFF					HDMI_IOWR(100, unsigned int)
#define MTK_HDMI_CEC_SET_RETRY_CNT				HDMI_IOWR(101, unsigned int)



#define IS_INTERLACE_OUTPUT(res) (((res) == HDMI_VIDEO_1920x1080i_60Hz) || ((res) == HDMI_VIDEO_1920x1080i_50Hz) || ((res) == HDMI_VIDEO_720x480i_60Hz) || ((res) == HDMI_VIDEO_720x576i_50Hz))
