...
extern LCM_DRIVER otm8018b_dsi_xxx_lcm_drv;
extern LCM_DRIVER hx8379c_dsi_xxx_lcm_drv;
...
#if defined(CONFIG_OTM8018B_DSI_XXX)
	&otm8018b_dsi_xxx_lcm_drv,
#endif

#if defined(CONFIG_HX8379C_DSI_XXX)
	&hx8379c_dsi_xxx_lcm_drv,
#endif
