...
UINT32 u4VDecReadVP8VLD(UINT32 u4VDecID, UINT32 u4Addr)
{
    ...
    if (u4VDecID == 0)
    {
        u4Val = u4ReadReg(VP8_VLD_REG_OFFSET0 + u4Addr);
    ...
    {
        u4Val = u4ReadReg(VP8_VLD_REG_OFFSET1 + u4Addr);
...
UINT32 u4VDecReadVP8MV(UINT32 u4VDecID, UINT32 u4Addr)
{
    ...
    if (u4VDecID == 0)
    {
		u4Val = u4ReadReg(VP8_MV_REG_OFFSET0 + u4Addr);
    ...
    {
		u4Val = u4ReadReg(VP8_MV_REG_OFFSET1 + u4Addr);
...
UINT32 u4VDecReadVP8PP(UINT32 u4VDecID, UINT32 u4Addr)
{
    ...
    if (u4VDecID == 0)
    {
        u4Val = u4ReadReg(VP8_PP_REG_OFFSET0 + u4Addr);
    ...
    {
        u4Val = u4ReadReg(VP8_PP_REG_OFFSET1 + u4Addr);
