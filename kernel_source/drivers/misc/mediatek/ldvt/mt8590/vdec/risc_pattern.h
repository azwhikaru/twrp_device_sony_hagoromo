...
{   
    ...
    for ( i = start_r ; i <= end_r ; i++ )
    {
        ...
        if ( base_r == 0xF6021000 )
            printk("VLD[%d] = 0x%08.0X    ",i,u4Value, base_r + 4*i);
        if ( base_r == 0xF6022000 )
            printk("MC[%d]  = 0x%08.0X    ",i,u4Value, base_r + 4*i);
        if ( base_r == 0xF6028000 )
            printk("HEVC_VLD[%d] = 0x%08.0X    ",i,u4Value, base_r + 4*i);
        if ( base_r == 0xF6025000 )
            printk("PP[%d] = 0x%08.0X    ",i,u4Value, base_r + 4*i);
        if ( base_r == 0xF6024000 )
            printk("MV[%d] = 0x%08.0X    ",i,u4Value, base_r + 4*i);
        if ( base_r == 0xF6020000 )
            printk("MISC[%d] = 0x%08.0X    ",i,u4Value, base_r + 4*i);
        if ( base_r == 0xF6021800 )
            printk("VLD_TOP[%d] = 0x%08.0X    ",i,u4Value, base_r + 4*i);
        if ((i - start_r)%2)
        {
            printk("\n");
        }
