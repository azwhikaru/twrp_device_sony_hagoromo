  ...
  UINT32 u4CurrPicDispWidth, UINT32 u4CurrPicDispHeight)
{
  ...
  */
...
#if 0 //Test
    vRM_VDecWrite_ImgResz(0, IMG_RESZ_START * 4, 0xC);
    vRM_VDecWrite_ImgResz(0, IMG_RESZ_START * 4, 0x0);
#endif

    *(volatile UINT32 *)(0xF6000008) = 0xFF;
    
  {
	...
	printk("u4RM_VDecRead_ImgResz is 0x%lx\n", u4Value);
  }
  ...
  if (_tVerMpvDecPrm[u4InstID].SpecDecPrm.rVDecRMDecPrm.fgRPRRacingModeEnable)
  {
    ...
    vRM_VDecWrite_ImgResz(0, RZ_JPG_V_CB * 4, 0x00000010);
	{
		...
		printk("u4RM_VDecRead_ImgResz test1 is 0x%lx\n", u4Value);
    }
  }
  else	
  {
    vRM_VDecWrite_ImgResz(0, RZ_RPR * 4, 1); // RPR_test, urcrpr = 0
    u4RM_VDecRead_ImgResz(0, RZ_RPR * 4);
	vRM_VDecWrite_ImgResz(0, IMG_RESZ_JPG_MODE * 4, 0x8001E000);
    vRM_VDecWrite_ImgResz(0, RZ_JPG_V_Y * 4, 0x00000020);
    vRM_VDecWrite_ImgResz(0, RZ_JPG_V_CB * 4, 0x00000010);
	{
		...
		printk("u4RM_VDecRead_ImgResz test2 is 0x%lx\n", u4Value);
    }
  }
  ...
  #ifdef RM_DDR3MODE_ENABLE
  {
   ...
   else
   {
		...
		printk("RZ_TG_BUF_LEN value is 0x%lx\n", (qw + (u4AlignSize << 12)) | 0xC0000000);
   }
#else
