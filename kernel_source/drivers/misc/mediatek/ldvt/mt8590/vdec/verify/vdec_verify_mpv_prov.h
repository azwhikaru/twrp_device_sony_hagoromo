...
extern UCHAR *_pucVP9CRCYBuf2[2]; // multi-core 1
extern UCHAR *_pucVP9CRCCBuf2[2]; // multi-core 1


extern UINT32 _u4K2KMode[2];
extern UINT32 _u4LaeMode[2];
extern UINT32 _u4DualCoreEnable[4];
extern UCHAR *_pucTileBuf;
extern UCHAR *_pucCountTBLBuffer;
extern UCHAR *_pucProbTBLBuffer;
