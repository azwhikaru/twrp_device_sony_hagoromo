...
static unsigned int smi_port0_in_larbx[SMI_LARB_NR+1] = {0, 11, 21, 44, 44, 46, 50, 53};
static unsigned int m4u_port0_in_larbx[SMI_LARB_NR+1] = {0, 11, 21, 44, 44, 46, 50, 53};
...
static irqreturn_t MTK_M4U_isr(int irq, void *dev_id)
{
    ...
    if(IntrSrc&F_INT_TRANSLATION_FAULT)
    {
        ...
        M4UMSG("translation fault: larb=%d,port=%s(%d), fault_mva=0x%x, reg 0x%x\n",
            larbID, m4u_get_port_name(larb_port_2_m4u_port(larbID, portID)),
            portID, faultMva, port_regval);
...
static char* m4u_get_port_name(M4U_PORT_ID_ENUM portID)
{
   ...
   switch(portID)
	...
	case VENC_CUR_CHROMA	 :   return "VENC_CUR_CHROMA"	  ;
        ...
        case BDP_VDO: 			return "BDP_VDO";
        case BDP_WR_CHANEL_DI: 		return "BDP_WR_CHANEL_DI";
        case BDP_NR: 			return "BDP_NR";
        case BDP_REL_DECODE: 		return "BDP_REL_DECODE";

        case BDP_WR_CHANNEL_VDI: 	return "BDP_WR_CHANNEL_VDI";
        case BDP_OSD: 			return "BDP_OSD";
        case BDP_TVE: 			return "BDP_TVE";
