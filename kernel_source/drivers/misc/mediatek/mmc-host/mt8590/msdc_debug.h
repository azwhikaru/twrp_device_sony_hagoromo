...
#define MSDC_DBGZONE_SDIODRV       (1 << 20)
#define MSDC_DBGZONE_ETTAGENT      (1 << 21)
...
#define STR_MSDC_SDIODRV            "SDIODRV"
#define STR_MSDC_ETTAGENT           "ETTAGENT"
...
#define MSDC_SDIODRV               MSDCDBGZONE(MSDC_DBGZONE_SDIODRV)
#define MSDC_ETTAGENT              MSDCDBGZONE(MSDC_DBGZONE_ETTAGENT)

//#define MSDC_DBGZONE_RELEASE       MSDC_DBGZONE_INIT|MSDC_DBGZONE_ERROR|MSDC_DBGZONE_INFO|MSDC_DBGZONE_CONFIG\
	                              |MSDC_DBGZONE_DBGDRV|MSDC_DBGZONE_MISCDRV|MSDC_DBGZONE_OTPDRV |MSDC_DBGZONE_SDIODRV|MSDC_DBGZONE_ETTAGENT            

#define MSDC_DBGZONE_RELEASE       MSDC_DBGZONE_INIT|MSDC_DBGZONE_ERROR
...
MSDCDBGZNHELPER  g_MsdcZnHelper = {
		{  STR_MSDC_INIT,    STR_MSDC_WARNING,   STR_MSDC_ERROR,   STR_MSDC_INFO,
	       ...
	       STR_MSDC_SDIODRV, STR_MSDC_ETTAGENT,  STR_MSDC_UNUSED,  STR_MSDC_UNUSED,
