...
#define MAX_BD_NUM          (8192)
#else
#define MAX_BD_NUM          (1024)
#endif /* CONFIG_ICX_MMC_TEST */
...
#if defined(MTK_DUALCARD_SUPPORT)
#define EINT_MSDC2_INS_DEBOUNCE_CN     500
#define EINT_MSDC2_INS_SENSITIVE        CUST_EINT_LEVEL_SENSITIVE
#define EINT_MSDC2_INS_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE
#endif
...
/* 
 *  This definition is used for MT8590_GPIO_RegMap.doc by candy.li on 2014-9-03 
 *  Zhanyong.Wang
 *  2014/11/28
 */
...
/*
  *  this definition is used for 8163_apmixedsys_register_map.xls by ???? 
  *  Zhanyong.Wang
  *  2015/03/24
  */
#if 10  
...
#endif
#if APMIXEDSYS_BASE != 0xF0209000
#error  Please check your APMIXEDSYS_BASE definition!!!!
#endif
#endif
#define REG_APMIXEDSYS_BASE(x)                     ((volatile unsigned int *)(APMIXEDSYS_BASE + OFFSET_##x))
...
#define BIT_MSDCPLL_SDM_ISO_EN                      B_APMIXEDSYS_MSDCPLL_POSDIV
...
#define OFFSET_MSDCPLL_CON0                        (0x240)
#define OFFSET_MSDCPLL_CON1                        (0x244)
#define OFFSET_MSDCPLL_PWR_CON0                    (0x24C)


/* 10209240	MSDCPLL_CON0     MSDCPLL Control Register 0	00000120 */
...
/* 10209244	MSDCPLL_CON1 MSDCPLL Control Register 1	800F6276 */
...
/*
  *  this definition is used for MT8590_TOPCKGEN_Registers.docx by chengbin.Gao 
  *  Zhanyong.Wang
  *  2014/12/14
  */
#if 10  
...
#endif
#if PERICFG_BASE != 0xF0003000
#error  Please check your PERICFG_BASE definition!!!!
#endif
#endif                        

#define REG_PERICFG_BASE(x)               ((volatile unsigned int *)(PERICFG_BASE + OFFSET_##x))

/*valid reg name list: 
    PERI_GLOBALCON_RST0, 
    PERI_GLOBALCON_PDN0_SET,       PERI_GLOBALCON_PDN0_CLR         PERI_GLOBALCON_PDN0_STA
    PERI_GLOBALCON_PDN_MD1_SET, PERI_GLOBALCON_PDN_MD1_CLR  PERI_GLOBALCON_PDN_MD1_STA
    PERI_GLOBALCON_PDN_MD2_SET, PERI_GLOBALCON_PDN_MD2_CLR  PERI_GLOBALCON_PDN_MD2_STA
    */
#define PERICFG_CTRL(pericfgreg)           PERICFG_##pericfgreg

/*
  * id valid range "MSDC30_[0, 3] and MSDC50_3"
  * op valid range "SET,CLR, STA" 
  */
#define MSDC_PERICFG_PDN0(id, op)                   B_##id##_PDN0_##op
#define MSDC_PERICFG_PDN_MD1(id, op)                B_##id##_PDN_MD1_##op
#define MSDC_PERICFG_PND_MD2(id, op)                B_##id##_PDN_MD2_##op

#define OFFSET_PERI_GLOBALCON_RST0                  0x0000
#define OFFSET_PERI_GLOBALCON_PDN0_SET              0x0008
#define OFFSET_PERI_GLOBALCON_PDN0_CLR              0x0010
#define OFFSET_PERI_GLOBALCON_PDN0_STA              0x0018
#define OFFSET_PERI_GLOBALCON_PDN_MD1_SET           0x0020
#define OFFSET_PERI_GLOBALCON_PDN_MD1_CLR           0x0028
#define OFFSET_PERI_GLOBALCON_PDN_MD1_STA           0x0030
#define OFFSET_PERI_GLOBALCON_PDN_MD2_SET           0x0024
#define OFFSET_PERI_GLOBALCON_PDN_MD2_CLR           0x002C
#define OFFSET_PERI_GLOBALCON_PDN_MD2_STA           0x0034

/* 10003000	PERI_GLOBALCON_RST0 Peripheral Software Reset Register0	00000000 */
#define PERICFG_PERI_GLOBALCON_RST0                 REG_PERICFG_BASE(PERI_GLOBALCON_RST0)
#define B_MSDC3_SW_RST	                            (1 << 21)	/*	MSDC3 software reset,0: Not reset MSDC3,1: Reset MSDC3 */
#define B_MSDC1_SW_RST	                            (1 << 20)	/*	MSDC1 software reset,0: Not reset MSDC1,1: Reset MSDC1 */
#define B_MSDC0_SW_RST	                            (1 << 19)	/*	MSDC0 software reset,0: Not reset MSDC0,1: Reset MSDC0 */
#define B_MSDC2_SW_RST	                            (1 << 17)	/*	MSDC2 software reset,0: Not reset MSDC2,1: Reset MSDC2 */
																	

/*10003008	PERI_GLOBALCON_PDN0_SET Peripheral Power Down0 Register Set	00000000 */
#define PERICFG_PERI_GLOBALCON_PDN0_SET             REG_PERICFG_BASE(PERI_GLOBALCON_PDN0_SET)
#define B_MSDC50_3_PDN0_SET	                        (1 << 17)	/*	MSDC50_3 power down,0: keep original value,1: Power down MSDC50_3 */
#define B_MSDC30_3_PDN0_SET	                        (1 << 16)	/*	MSDC30_3 power down,0: keep original value,1: Power down MSDC30_3 */
#define B_MSDC30_2_PDN0_SET	                        (1 << 15)	/*	MSDC30_2 power down,0: keep original value,1: Power down MSDC30_2 */
#define B_MSDC30_1_PDN0_SET	                        (1 << 14)	/*	MSDC30_1 power down,0: keep original value,1: Power down MSDC30_1 */
#define B_MSDC30_0_PDN0_SET	                        (1 << 13)	/*	MSDC30_0 power down,0: keep original value,1: Power down MSDC30_0 */


/* 10003010	PERI_GLOBALCON_PDN0_CLR Peripheral Power Down0 Register Clear	00000000 */
#define PERICFG_PERI_GLOBALCON_PDN0_CLR             REG_PERICFG_BASE(PERI_GLOBALCON_PDN0_CLR)
#define B_MSDC50_3_PDN0_CLR 	                    (1 << 17)	/*	MSDC50_3 clear power down,0: keep original value,1: clear power down MSDC50_3 */
#define B_MSDC30_3_PDN0_CLR 	                    (1 << 16)	/*	MSDC30_3 clear power down,0: keep original value,1: clear power down MSDC30_3 */
#define B_MSDC30_2_PDN0_CLR 	                    (1 << 15)	/*	MSDC30_2 clear power down,0: keep original value,1: clear power down MSDC30_2 */
#define B_MSDC30_1_PDN0_CLR 	                    (1 << 14)	/*	MSDC30_1 clear power down,0: keep original value,1: clear power down MSDC30_1 */
#define B_MSDC30_0_PDN0_CLR 	                    (1 << 13)	/*	MSDC30_0 clear power down,0: keep original value,1: clear power down MSDC30_0 */


/* 10003018	PERI_GLOBALCON_PDN0_STA Peripheral Power Down0 Register  Status	00000000 */
#define PERICFG_PERI_GLOBALCON_PDN0_STA             REG_PERICFG_BASE(PERI_GLOBALCON_PDN0_STA)
#define B_MSDC50_3_PDN0_STA	                        (1 << 17)	/* 	MSDC50_3 power down,0: keep original value,1: Power down MSDC50_3 */
#define B_MSDC30_3_PDN0_STA	                        (1 << 16)	/* 	MSDC30_3 power down,0: keep original value,1: Power down MSDC30_3 */
#define B_MSDC30_2_PDN0_STA	                        (1 << 15)	/* 	MSDC30_2 power down,0: keep original value,1: Power down MSDC30_2 */
#define B_MSDC30_1_PDN0_STA	                        (1 << 14)	/* 	MSDC30_1 power down,0: keep original value,1: Power down MSDC30_1 */
#define B_MSDC30_0_PDN0_STA	                        (1 << 13)	/* 	MSDC30_0 power down,0: keep original value,1: Power down MSDC30_0 */

/* 10003020	PERI_GLOBALCON_PDN_MD1_SET Peripheral MD1 Power Down0 Register Set	00000000 */
#define PERICFG_PERI_GLOBALCON_PDN_MD1_SET          REG_PERICFG_BASE(PERI_GLOBALCON_PDN_MD1_SET)
#define B_MSDC50_3_PDN_MD1_SET	                    (1 << 17)	/* 	MSDC50_3 power down,0: keep original value,1: Power down MSDC50_3 */
#define B_MSDC30_3_PDN_MD1_SET	                    (1 << 16)	/* 	MSDC30_3 power down,0: keep original value,1: Power down MSDC30_3 */
#define B_MSDC30_2_PDN_MD1_SET	                    (1 << 15)	/* 	MSDC30_2 power down,0: keep original value,1: Power down MSDC30_2 */
#define B_MSDC30_1_PDN_MD1_SET	                    (1 << 14)	/* 	MSDC30_1 power down,0: keep original value,1: Power down MSDC30_1 */
#define B_MSDC30_0_PDN_MD1_SET	                    (1 << 13)	/* 	MSDC30_0 power down,0: keep original value,1: Power down MSDC30_0 */

/* 10003028	PERI_GLOBALCON_PDN_MD1_CLR Peripheral MD1 Power Down0 Register Clear	00000000 */
#define PERICFG_PERI_GLOBALCON_PDN_MD1_CLR          REG_PERICFG_BASE(PERI_GLOBALCON_PDN_MD1_CLR)
#define B_MSDC50_3_PDN_MD1_CLR	                    (1 << 17)	/* 	MSDC50_3 clear power down,0: keep original value,1: clear power down MSDC50_3 */
#define B_MSDC30_3_PDN_MD1_CLR	                    (1 << 16)	/* 	MSDC30_3 clear power down,0: keep original value,1: clear power down MSDC30_3 */
#define B_MSDC30_2_PDN_MD1_CLR	                    (1 << 15)	/* 	MSDC30_2 clear power down,0: keep original value,1: clear power down MSDC30_2 */
#define B_MSDC30_1_PDN_MD1_CLR	                    (1 << 14)	/* 	MSDC30_1 clear power down,0: keep original value,1: clear power down MSDC30_1 */
#define B_MSDC30_0_PDN_MD1_CLR	                    (1 << 13)	/* 	MSDC30_0 clear power down,0: keep original value,1: clear power down MSDC30_0 */


/* 10003030	PERI_GLOBALCON_PDN_MD1_STA Peripheral MD1 Power Down0 Register  Status	00000000 */
#define PERICFG_PERI_GLOBALCON_PDN_MD1_STA          REG_PERICFG_BASE(PERI_GLOBALCON_PDN_MD1_STA)
#define B_MSDC50_3_PDN_MD1_STA	                    (1 << 17)	/* 	MSDC50_3 power down,0: keep original value,1: Power down MSDC50_3 */
#define B_MSDC30_3_PDN_MD1_STA	                   	(1 << 16)	/* 	MSDC30_3 power down,0: keep original value,1: Power down MSDC30_3 */
#define B_MSDC30_2_PDN_MD1_STA	                   	(1 << 15)	/* 	MSDC30_2 power down,0: keep original value,1: Power down MSDC30_2 */
#define B_MSDC30_1_PDN_MD1_STA	                   	(1 << 14)	/* 	MSDC30_1 power down,0: keep original value,1: Power down MSDC30_1 */
#define B_MSDC30_0_PDN_MD1_STA	                   	(1 << 13)	/* 	MSDC30_0 power down,0: keep original value,1: Power down MSDC30_0 */

/* 10003024	PERI_GLOBALCON_PDN_MD2_SET Peripheral MD2 Power Down0 Register Set	00000000 */
#define PERICFG_PERI_GLOBALCON_PDN_MD2_SET          REG_PERICFG_BASE(PERI_GLOBALCON_PDN_MD2_SET)
#define B_MSDC50_3_PDN_MD2_SET	                   	(1 << 17)	/* 	MSDC50_3 power down,0: keep original value,1: Power down MSDC50_3 */
#define B_MSDC30_3_PDN_MD2_SET	                   	(1 << 16)	/* 	MSDC30_3 power down,0: keep original value,1: Power down MSDC30_3 */
#define B_MSDC30_2_PDN_MD2_SET	                   	(1 << 15)	/* 	MSDC30_2 power down,0: keep original value,1: Power down MSDC30_2 */
#define B_MSDC30_1_PDN_MD2_SET	                   	(1 << 14)	/* 	MSDC30_1 power down,0: keep original value,1: Power down MSDC30_1 */
#define B_MSDC30_0_PDN_MD2_SET	                   	(1 << 13)	/* 	MSDC30_0 power down,0: keep original value,1: Power down MSDC30_0 */

/* 1000302C	PERI_GLOBALCON_PDN_MD2_CLR Peripheral MD2 Power Down0 Register Clear	00000000 */
#define PERICFG_PERI_GLOBALCON_PDN_MD2_CLR          REG_PERICFG_BASE(PERI_GLOBALCON_PDN_MD2_CLR)
#define B_MSDC50_3_PDN_MD2_CLR	                   	(1 << 17)	/* 	MSDC50_3 clear power down,0: keep original value,1: clear power down MSDC50_3 */
#define B_MSDC30_3_PDN_MD2_CLR	                   	(1 << 16)	/* 	MSDC30_3 clear power down,0: keep original value,1: clear power down MSDC30_3 */
#define B_MSDC30_2_PDN_MD2_CLR	                   	(1 << 15)	/* 	MSDC30_2 clear power down,0: keep original value,1: clear power down MSDC30_2 */
#define B_MSDC30_1_PDN_MD2_CLR	                   	(1 << 14)	/* 	MSDC30_1 clear power down,0: keep original value,1: clear power down MSDC30_1 */
#define B_MSDC30_0_PDN_MD2_CLR	                   	(1 << 13)	/* 	MSDC30_0 clear power down,0: keep original value,1: clear power down MSDC30_0 */


/* 10003034	PERI_GLOBALCON_PDN_MD2_STA Peripheral MD2 Power Down0 Register  Status	00000000 */
#define PERICFG_PERI_GLOBALCON_PDN_MD2_STA          REG_PERICFG_BASE(PERI_GLOBALCON_PDN_MD2_STA)
#define B_MSDC50_3_PDN_MD2_STA	                   	(1 << 17)	/* MSDC50_3 power down 0: keep original value,1: Power down MSDC50_3 */
#define B_MSDC30_3_PDN_MD2_STA	                   	(1 << 16)	/* MSDC30_3 power down 0: keep original value,1: Power down MSDC30_3 */
#define B_MSDC30_2_PDN_MD2_STA	                   	(1 << 15)	/* MSDC30_2 power down 0: keep original value,1: Power down MSDC30_2 */
#define B_MSDC30_1_PDN_MD2_STA	                   	(1 << 14)	/* MSDC30_1 power down 0: keep original value,1: Power down MSDC30_1 */
#define B_MSDC30_0_PDN_MD2_STA	                   	(1 << 13)	/* MSDC30_0 power down 0: keep original value,1: Power down MSDC30_0 */
...
extern int msdc_eint_register(void *ops, bool enable);
extern void msdc_set_carddet_func(void *func);
