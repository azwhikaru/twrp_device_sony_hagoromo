...
/* micro-volt */
unsigned int mt8590_vcore_tbl[] = {
	700000, /*	0x00 0000000b, 0.70000V */
	706250, /*	0x01 0000001b, 0.70625V */
	712500, /*	0x02 0000010b, 0.71250V */
	718750, /*	0x03 0000011b, 0.71875V */
	725000, /*	0x04 0000100b, 0.72500V */
	731250, /*	0x05 0000101b, 0.73125V */
	737500, /*	0x06 0000110b, 0.73750V */
	743750, /*	0x07 0000111b, 0.74375V */
	750000, /*	0x08 0001000b, 0.75000V */
	756250, /*	0x09 0001001b, 0.75625V */
	762500, /*	0x0A 0001010b, 0.76250V */
	768750, /*	0x0B 0001011b, 0.76875V */
	775000, /*	0x0C 0001100b, 0.77500V */
	781250, /*	0x0D 0001101b, 0.78125V */
	787500, /*	0x0E 0001110b, 0.78750V */
	793750, /*	0x0F 0001111b, 0.79375V */
	800000, /*	0x10 0010000b, 0.80000V */
	806250, /*	0x11 0010001b, 0.80625V */
	812500, /*	0x12 0010010b, 0.81250V */
	818750, /*	0x13 0010011b, 0.81875V */
	825000, /*	0x14 0010100b, 0.82500V */
	831250, /*	0x15 0010101b, 0.83125V */
	837500, /*	0x16 0010110b, 0.83750V */
	843750, /*	0x17 0010111b, 0.84375V */
	850000, /*	0x18 0011000b, 0.85000V */
	856250, /*	0x19 0011001b, 0.85625V */
	862500, /*	0x1A 0011010b, 0.86250V */
	868750, /*	0x1B 0011011b, 0.86875V */
	875000, /*	0x1C 0011100b, 0.87500V */
	881250, /*	0x1D 0011101b, 0.88125V */
	887500, /*	0x1E 0011110b, 0.88750V */
	893750, /*	0x1F 0011111b, 0.89375V */
	900000, /*	0x20 0100000b, 0.90000V */
	906250, /*	0x21 0100001b, 0.90625V */
	912500, /*	0x22 0100010b, 0.91250V */
	918750, /*	0x23 0100011b, 0.91875V */
	925000, /*	0x24 0100100b, 0.92500V */
	931250, /*	0x25 0100101b, 0.93125V */
	937500, /*	0x26 0100110b, 0.93750V */
	943750, /*	0x27 0100111b, 0.94375V */
	950000, /*	0x28 0101000b, 0.95000V */
	956250, /*	0x29 0101001b, 0.95625V */
	962500, /*	0x2A 0101010b, 0.96250V */
	968750, /*	0x2B 0101011b, 0.96875V */
	975000, /*	0x2C 0101100b, 0.97500V */
	981250, /*	0x2D 0101101b, 0.98125V */
	987500, /*	0x2E 0101110b, 0.98750V */
	993750, /*	0x2F 0101111b, 0.99375V */
	1000000, /*	0x30 0110000b, 1.00000V */
	1006250, /*	0x31 0110001b, 1.00625V */
	1012500, /*	0x32 0110010b, 1.01250V */
	1018750, /*	0x33 0110011b, 1.01875V */
	1025000, /*	0x34 0110100b, 1.02500V */
	1031250, /*	0x35 0110101b, 1.03125V */
	1037500, /*	0x36 0110110b, 1.03750V */
	1043750, /*	0x37 0110111b, 1.04375V */
	1050000, /*	0x38 0111000b, 1.05000V */
	1056250, /*	0x39 0111001b, 1.05625V */
	1062500, /*	0x3A 0111010b, 1.06250V */
	1068750, /*	0x3B 0111011b, 1.06875V */
	1075000, /*	0x3C 0111100b, 1.07500V */
	1081250, /*	0x3D 0111101b, 1.08125V */
	1087500, /*	0x3E 0111110b, 1.08750V */
	1093750, /*	0x3F 0111111b, 1.09375V */
	1100000, /*	0x40 1000000b, 1.10000V */
	1106250, /*	0x41 1000001b, 1.10625V */
	1112500, /*	0x42 1000010b, 1.11250V */
	1118750, /*	0x43 1000011b, 1.11875V */
	1125000, /*	0x44 1000100b, 1.12500V */
	1131250, /*	0x45 1000101b, 1.13125V */
	1137500, /*	0x46 1000110b, 1.13750V */
	1143750, /*	0x47 1000111b, 1.14375V */
	1150000, /*	0x48 1001000b, 1.15000V */
	1156250, /*	0x49 1001001b, 1.15625V */
	1162500, /*	0x4A 1001010b, 1.16250V */
	1168750, /*	0x4B 1001011b, 1.16875V */
	1175000, /*	0x4C 1001100b, 1.17500V */
	1181250, /*	0x4D 1001101b, 1.18125V */
	1187500, /*	0x4E 1001110b, 1.18750V */
	1193750, /*	0x4F 1001111b, 1.19375V */
	1200000, /*	0x50 1010000b, 1.20000V */
	1206250, /*	0x51 1010001b, 1.20625V */
	1212500, /*	0x52 1010010b, 1.21250V */
	1218750, /*	0x53 1010011b, 1.21875V */
	1225000, /*	0x54 1010100b, 1.22500V */
	1231250, /*	0x55 1010101b, 1.23125V */
	1237500, /*	0x56 1010110b, 1.23750V */
	1243750, /*	0x57 1010111b, 1.24375V */
	1250000, /*	0x58 1011000b, 1.25000V */
	1256250, /*	0x59 1011001b, 1.25625V */
	1262500, /*	0x5A 1011010b, 1.26250V */
	1268750, /*	0x5B 1011011b, 1.26875V */
	1275000, /*	0x5C 1011100b, 1.27500V */
	1281250, /*	0x5D 1011101b, 1.28125V */
	1287500, /*	0x5E 1011110b, 1.28750V */
	1293750, /*	0x5F 1011111b, 1.29375V */
	1300000, /*	0x60 1100000b, 1.30000V */
	1306250, /*	0x61 1100001b, 1.30625V */
	1312500, /*	0x62 1100010b, 1.31250V */
	1318750, /*	0x63 1100011b, 1.31875V */
	1325000, /*	0x64 1100100b, 1.32500V */
	1331250, /*	0x65 1100101b, 1.33125V */
	1337500, /*	0x66 1100110b, 1.33750V */
	1343750, /*	0x67 1100111b, 1.34375V */
	1350000, /*	0x68 1101000b, 1.35000V */
	1356250, /*	0x69 1101001b, 1.35625V */
	1362500, /*	0x6A 1101010b, 1.36250V */
	1368750, /*	0x6B 1101011b, 1.36875V */
	1375000, /*	0x6C 1101100b, 1.37500V */
	1381250, /*	0x6D 1101101b, 1.38125V */
	1387500, /*	0x6E 1101110b, 1.38750V */
	1393750, /*	0x6F 1101111b, 1.39375V */
	1400000, /*	0x70 1110000b, 1.40000V */
	1406250, /*	0x71 1110001b, 1.40625V */
	1412500, /*	0x72 1110010b, 1.41250V */
	1418750, /*	0x73 1110011b, 1.41875V */
	1425000, /*	0x74 1110100b, 1.42500V */
	1431250, /*	0x75 1110101b, 1.43125V */
	1437500, /*	0x76 1110110b, 1.43750V */
	1443750, /*	0x77 1110111b, 1.44375V */
	1450000, /*	0x78 1111000b, 1.45000V */
	1456250, /*	0x79 1111001b, 1.45625V */
	1462500, /*	0x7A 1111010b, 1.46250V */
	1468750, /*	0x7B 1111011b, 1.46875V */
	1475000, /*	0x7C 1111100b, 1.47500V */
	1481250, /*	0x7D 1111101b, 1.48125V */
	1487500, /*	0x7E 1111110b, 1.48750V */
	1493750  /*	0x7F 1111111b  1.49375V */
};
...
#elif (AUTOK_VCORE_SCAN_NUM == 4)
unsigned int g_autok_vcore_sel[AUTOK_VCORE_SCAN_NUM] = {
    1050000, 1150000, 1200000, 1300000};
...
//#endif
    ...
    pmic_read_interface(0x0224, &pmic_vcore, 0x7f, 0);
    AUTOK_PRINT("pmic_vcore: 0x%x\n",pmic_vcore);
    
    //pmic_read_interface(0x0a80, &pmic_vio18, 0xf, 8);
    //AUTOK_PRINT("pmic_vio18: 0x%x\n",pmic_vio18);

    vcore_uv = 700000 + 6250 * pmic_vcore;
    AUTOK_PRINT("vcore_uv: %d uv\n",vcore_uv);

    size = sizeof(mt8590_vcore_tbl)/sizeof(mt8590_vcore_tbl[0]);

    if (vcore_uv <= mt8590_vcore_tbl[0]) {
        vcore_sel = 0;
    } else if (vcore_uv >= mt8590_vcore_tbl[size - 1]) {
        vcore_sel = size - 1;
    } else {		
        for (idx = 0 ; idx < size -1 ; idx ++) {
            if ((vcore_uv >= mt8590_vcore_tbl[idx]) && 
                (vcore_uv < mt8590_vcore_tbl[idx+1])) {
    ...
    AUTOK_PRINT("[%s] Current Vcore = %duV(0x%x)\r\n", __func__, mt8590_vcore_tbl[vcore_sel], vcore_sel);
...
static int autok_recovery(struct msdc_host *host)
{
    ...
    MSDC_RESET();
    MSDC_CLR_FIFO();
    MSDC_WRITE32(MSDC_INT, sdr_read32(MSDC_INT));
#endif
...
exit:
    AUTOK_PRINT("Restore vcore to %duV\r\n", mt8590_vcore_tbl[offset_restore]);
    autok_vcore_set(mt8590_vcore_tbl[offset_restore]);
