...
int load_exist_part_tab(u8 * buf)
{
	...
	MSG(INIT, "[bayi] load exist part tab :pt_start_addr 0x%x \n",pt_start_addr);
...
#endif
	if (part_num == PART_MAX_COUNT)
    {
        printk(KERN_INFO "error: partition number more than 40 \n");
