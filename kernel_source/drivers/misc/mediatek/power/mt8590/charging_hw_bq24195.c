...
static void hw_bc11_dump_register(void)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
    ...
    bq24195_set_en_hiz(0x0);
    bq24195_set_vindpm(0xA); //VIN DPM check 4.68V
    bq24195_set_reg_rst(0x0);
	bq24195_set_wdt_rst(0x1); //Kick watchdog	
    bq24195_set_sys_min(0x5); //Minimum system voltage 3.5V	
	bq24195_set_iprechg(0x3); //Precharge current 512mA
	bq24195_set_iterm(0x0); //Termination current 128mA

#if defined(HIGH_BATTERY_VOLTAGE_SUPPORT)
    bq24195_set_vreg(0x32); //VREG 4.304V
#else
    bq24195_set_vreg(0x2C); //VREG 4.208V
#endif    
  
    bq24195_set_batlowv(0x1); //BATLOWV 3.0V
    bq24195_set_vrechg(0x0); //VRECHG 0.1V (4.108V)
    bq24195_set_en_term(0x1); //Enable termination
    bq24195_set_watchdog(0x1); //WDT 40s
    bq24195_set_en_timer(0x0); //Disable charge timer
    bq24195_set_int_mask(0x0); //Disable fault interrupt
 ...
 static kal_uint32 charging_enable(void *data)
 {
	...
	{
		bq24195_set_en_hiz(0x0);	            	
        bq24195_set_chg_config(0x1); // charger enable
	}
	else
	{
 ...
 static kal_uint32 charging_set_cv_voltage(void *data)
 {
	...
	bq24195_set_vreg(register_value); 
 ...
 static kal_uint32 charging_get_current(void *data)
 {
    ...
    //Get current level
    bq24195_read_interface(bq24195_CON2, &ret_val, CON2_ICHG_MASK, CON2_ICHG_SHIFT);
    
    //Get Force 20% option
    bq24195_read_interface(bq24195_CON2, &ret_force_20pct, CON2_FORCE_20PCT_MASK, CON2_FORCE_20PCT_SHIFT);
 ...
 static kal_uint32 charging_set_current(void *data)
 {
	...
	bq24195_set_ichg(register_value);
 ...
 static kal_uint32 charging_set_input_current(void *data)
 {
    ...
    bq24195_set_iinlim(register_value);
...
static kal_uint32 charging_set_power_off(void *data)
{
    ...
    pr_debug("charging_set_power_off=%d\n");
    mt_power_off();
