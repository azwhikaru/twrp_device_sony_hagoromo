...
struct task_struct *pmic_interrupt_thread = NULL;
static bool pmic_thread_shutdown = false;
...
static regmon_reg_info_t mt6323_regmon_reg_info[] = {
	{"CHR_CON0", CHR_CON0},
	{"CHR_CON1", CHR_CON1},
	{"CHR_CON2", CHR_CON2},
	{"CHR_CON3", CHR_CON3},
	...
	{"CHR_CON28", CHR_CON28},
	{"CHR_CON29", CHR_CON29},
	{"STRUP_CON0", STRUP_CON0},
	{"STRUP_CON2", STRUP_CON2},
	{"STRUP_CON3", STRUP_CON3},
	{"STRUP_CON4", STRUP_CON4},
	{"STRUP_CON5", STRUP_CON5},
	{"STRUP_CON6", STRUP_CON6},
	{"STRUP_CON7", STRUP_CON7},
	{"STRUP_CON8", STRUP_CON8},
	{"STRUP_CON9", STRUP_CON9},
	{"STRUP_CON10", STRUP_CON10},
	{"STRUP_CON11", STRUP_CON11},
	{"SPK_CON0", SPK_CON0},
	{"SPK_CON1", SPK_CON1},
	{"SPK_CON2", SPK_CON2},
	{"SPK_CON6", SPK_CON6},
	...
	{"SPK_CON12", SPK_CON12},
	{"CID", CID},
	{"TOP_CKPDN0", TOP_CKPDN0},
	{"TOP_CKPDN0_SET", TOP_CKPDN0_SET},
	{"TOP_CKPDN0_CLR", TOP_CKPDN0_CLR},
	{"TOP_CKPDN1", TOP_CKPDN1},
	{"TOP_CKPDN1_SET", TOP_CKPDN1_SET},
	{"TOP_CKPDN1_CLR", TOP_CKPDN1_CLR},
	{"TOP_CKPDN2", TOP_CKPDN2},
	{"TOP_CKPDN2_SET", TOP_CKPDN2_SET},
	{"TOP_CKPDN2_CLR", TOP_CKPDN2_CLR},
	{"TOP_RST_CON", TOP_RST_CON},
	{"TOP_RST_CON_SET", TOP_RST_CON_SET},
	{"TOP_RST_CON_CLR", TOP_RST_CON_CLR},
	{"TOP_RST_MISC", TOP_RST_MISC},
	{"TOP_RST_MISC_SET", TOP_RST_MISC_SET},
	{"TOP_RST_MISC_CLR", TOP_RST_MISC_CLR},
	{"TOP_CKCON0", TOP_CKCON0},
	{"TOP_CKCON0_SET", TOP_CKCON0_SET},
	{"TOP_CKCON0_CLR", TOP_CKCON0_CLR},
	{"TOP_CKCON1", TOP_CKCON1},
	{"TOP_CKCON1_SET", TOP_CKCON1_SET},
	{"TOP_CKCON1_CLR", TOP_CKCON1_CLR},
	{"TOP_CKTST0", TOP_CKTST0},
	{"TOP_CKTST1", TOP_CKTST1},
	{"TOP_CKTST2", TOP_CKTST2},
	{"TEST_OUT", TEST_OUT},
	{"TEST_CON0", TEST_CON0},
	{"TEST_CON1", TEST_CON1},
	{"EN_STATUS0", EN_STATUS0},
	...
	{"DRV_CON3", DRV_CON3},
	{"DRV_CON4", DRV_CON4},
	{"SIMLS1_CON", SIMLS1_CON},
	{"SIMLS2_CON", SIMLS2_CON},
	{"INT_CON0", INT_CON0},
	{"INT_CON0_SET", INT_CON0_SET},
	{"INT_CON0_CLR", INT_CON0_CLR},
	{"INT_CON1", INT_CON1},
	{"INT_CON1_SET", INT_CON1_SET},
	{"INT_CON1_CLR", INT_CON1_CLR},
	{"INT_MISC_CON", INT_MISC_CON},
	{"INT_MISC_CON_SET", INT_MISC_CON_SET},
	{"INT_MISC_CON_CLR", INT_MISC_CON_CLR},
	{"INT_STATUS0", INT_STATUS0},
	{"INT_STATUS1", INT_STATUS1},
	{"OC_GEAR_0", OC_GEAR_0},
	{"OC_GEAR_1", OC_GEAR_1},
	{"OC_GEAR_2", OC_GEAR_2},
	{"OC_CTL_VPROC", OC_CTL_VPROC},
	{"OC_CTL_VSYS", OC_CTL_VSYS},
	{"OC_CTL_VPA", OC_CTL_VPA},
	{"FQMTR_CON0", FQMTR_CON0},
	{"FQMTR_CON1", FQMTR_CON1},
	{"FQMTR_CON2", FQMTR_CON2},
	{"RG_SPI_CON", RG_SPI_CON},
	{"DEW_DIO_EN", DEW_DIO_EN},
	{"DEW_READ_TEST", DEW_READ_TEST},
	{"DEW_WRITE_TEST", DEW_WRITE_TEST},
	{"DEW_CRC_SWRST", DEW_CRC_SWRST},
	{"DEW_CRC_EN", DEW_CRC_EN},
	{"DEW_CRC_VAL", DEW_CRC_VAL},
	{"DEW_DBG_MON_SEL", DEW_DBG_MON_SEL},
	{"DEW_CIPHER_KEY_SEL", DEW_CIPHER_KEY_SEL},
	{"DEW_CIPHER_IV_SEL", DEW_CIPHER_IV_SEL},
	{"DEW_CIPHER_EN", DEW_CIPHER_EN},
	{"DEW_CIPHER_RDY", DEW_CIPHER_RDY},
	{"DEW_CIPHER_MODE", DEW_CIPHER_MODE},
	{"DEW_CIPHER_SWRST", DEW_CIPHER_SWRST},
	{"DEW_RDDMY_NO", DEW_RDDMY_NO},
	{"DEW_RDATA_DLY_SEL", DEW_RDATA_DLY_SEL},
	{"BUCK_CON0", BUCK_CON0},
	{"BUCK_CON1", BUCK_CON1},
	{"BUCK_CON2", BUCK_CON2},
	{"BUCK_CON3", BUCK_CON3},
	{"BUCK_CON4", BUCK_CON4},
	{"BUCK_CON5", BUCK_CON5},
	{"VPROC_CON0", VPROC_CON0},
	{"VPROC_CON1", VPROC_CON1},
	{"VPROC_CON2", VPROC_CON2},
	{"VPROC_CON3", VPROC_CON3},
	{"VPROC_CON4", VPROC_CON4},
	{"VPROC_CON5", VPROC_CON5},
	{"VPROC_CON7", VPROC_CON7},
	{"VPROC_CON8", VPROC_CON8},
	{"VPROC_CON9", VPROC_CON9},
	{"VPROC_CON10", VPROC_CON10},
	{"VPROC_CON11", VPROC_CON11},
	{"VPROC_CON12", VPROC_CON12},
	{"VPROC_CON13", VPROC_CON13},
	{"VPROC_CON14", VPROC_CON14},
	{"VPROC_CON15", VPROC_CON15},
	{"VPROC_CON18", VPROC_CON18},
	{"VSYS_CON0", VSYS_CON0},
	{"VSYS_CON1", VSYS_CON1},
	{"VSYS_CON2", VSYS_CON2},
	{"VSYS_CON3", VSYS_CON3},
	...
	{"VSYS_CON8", VSYS_CON8},
	{"VSYS_CON9", VSYS_CON9},
	{"VSYS_CON10", VSYS_CON10},
	{"VSYS_CON11", VSYS_CON11},
	{"VSYS_CON12", VSYS_CON12},
	{"VSYS_CON13", VSYS_CON13},
	{"VSYS_CON14", VSYS_CON14},
	{"VSYS_CON15", VSYS_CON15},
	{"VSYS_CON18", VSYS_CON18},
	{"VPA_CON0", VPA_CON0},
	{"VPA_CON1", VPA_CON1},
	{"VPA_CON2", VPA_CON2},
	{"VPA_CON3", VPA_CON3},
	...
	{"VPA_CON19", VPA_CON19},
	{"VPA_CON20", VPA_CON20},
	{"BUCK_K_CON0", BUCK_K_CON0},
	{"BUCK_K_CON1", BUCK_K_CON1},
	{"BUCK_K_CON2", BUCK_K_CON2},
	{"ISINK0_CON0", ISINK0_CON0},
	{"ISINK0_CON1", ISINK0_CON1},
	{"ISINK0_CON2", ISINK0_CON2},
	{"ISINK0_CON3", ISINK0_CON3},
	{"ISINK1_CON0", ISINK1_CON0},
	{"ISINK1_CON1", ISINK1_CON1},
	{"ISINK1_CON2", ISINK1_CON2},
	{"ISINK1_CON3", ISINK1_CON3},
	{"ISINK2_CON0", ISINK2_CON0},
	{"ISINK2_CON1", ISINK2_CON1},
	{"ISINK2_CON2", ISINK2_CON2},
	{"ISINK2_CON3", ISINK2_CON3},
	{"ISINK3_CON0", ISINK3_CON0},
	{"ISINK3_CON1", ISINK3_CON1},
	{"ISINK3_CON2", ISINK3_CON2},
	{"ISINK3_CON3", ISINK3_CON3},
	{"ISINK_ANA0", ISINK_ANA0},
	{"ISINK_ANA1", ISINK_ANA1},
	{"ISINK_PHASE_DLY", ISINK_PHASE_DLY},
	{"ISINK_EN_CTRL", ISINK_EN_CTRL},
	{"ANALDO_CON0", ANALDO_CON0},
	{"ANALDO_CON1", ANALDO_CON1},
	{"ANALDO_CON2", ANALDO_CON2},
	{"ANALDO_CON3", ANALDO_CON3},
	{"ANALDO_CON4", ANALDO_CON4},
	{"ANALDO_CON5", ANALDO_CON5},
	{"ANALDO_CON6", ANALDO_CON6},
	{"ANALDO_CON7", ANALDO_CON7},
	{"ANALDO_CON8", ANALDO_CON8},
	{"ANALDO_CON10", ANALDO_CON10},
	{"ANALDO_CON15", ANALDO_CON15},
	{"ANALDO_CON16", ANALDO_CON16},
	{"ANALDO_CON17", ANALDO_CON17},
	{"ANALDO_CON18", ANALDO_CON18},
	{"ANALDO_CON19", ANALDO_CON19},
	{"ANALDO_CON20", ANALDO_CON20},
	{"ANALDO_CON21", ANALDO_CON21},
	{"DIGLDO_CON0", DIGLDO_CON0},
	{"DIGLDO_CON2", DIGLDO_CON2},
	{"DIGLDO_CON3", DIGLDO_CON3},
	{"DIGLDO_CON5", DIGLDO_CON5},
	{"DIGLDO_CON6", DIGLDO_CON6},
	{"DIGLDO_CON7", DIGLDO_CON7},
	{"DIGLDO_CON8", DIGLDO_CON8},
	{"DIGLDO_CON9", DIGLDO_CON9},
	{"DIGLDO_CON10", DIGLDO_CON10},
	{"DIGLDO_CON11", DIGLDO_CON11},
	{"DIGLDO_CON12", DIGLDO_CON12},
	{"DIGLDO_CON13", DIGLDO_CON13},
	{"DIGLDO_CON14", DIGLDO_CON14},
	{"DIGLDO_CON15", DIGLDO_CON15},
	{"DIGLDO_CON16", DIGLDO_CON16},
	{"DIGLDO_CON17", DIGLDO_CON17},
	{"DIGLDO_CON18", DIGLDO_CON18},
	{"DIGLDO_CON19", DIGLDO_CON19},
	{"DIGLDO_CON20", DIGLDO_CON20},
	{"DIGLDO_CON21", DIGLDO_CON21},
	{"DIGLDO_CON23", DIGLDO_CON23},
	{"DIGLDO_CON24", DIGLDO_CON24},
	{"DIGLDO_CON26", DIGLDO_CON26},
	{"DIGLDO_CON27", DIGLDO_CON27},
	{"DIGLDO_CON28", DIGLDO_CON28},
	{"DIGLDO_CON29", DIGLDO_CON29},
	{"DIGLDO_CON30", DIGLDO_CON30},
	{"DIGLDO_CON31", DIGLDO_CON31},
	{"DIGLDO_CON32", DIGLDO_CON32},
	{"DIGLDO_CON33", DIGLDO_CON33},
	{"DIGLDO_CON34", DIGLDO_CON34},
	{"DIGLDO_CON35", DIGLDO_CON35},
	{"DIGLDO_CON36", DIGLDO_CON36},
	{"DIGLDO_CON39", DIGLDO_CON39},
	{"DIGLDO_CON40", DIGLDO_CON40},
	{"DIGLDO_CON41", DIGLDO_CON41},
	{"DIGLDO_CON42", DIGLDO_CON42},
	{"DIGLDO_CON43", DIGLDO_CON43},
	{"DIGLDO_CON44", DIGLDO_CON44},
	{"DIGLDO_CON45", DIGLDO_CON45},
	{"DIGLDO_CON46", DIGLDO_CON46},
	{"DIGLDO_CON47", DIGLDO_CON47},
	{"DIGLDO_CON48", DIGLDO_CON48},
	{"DIGLDO_CON49", DIGLDO_CON49},
	{"DIGLDO_CON50", DIGLDO_CON50},
	{"DIGLDO_CON51", DIGLDO_CON51},
	{"DIGLDO_CON52", DIGLDO_CON52},
	{"DIGLDO_CON53", DIGLDO_CON53},
	{"DIGLDO_CON54", DIGLDO_CON54},
	{"EFUSE_CON0", EFUSE_CON0},
	{"EFUSE_CON1", EFUSE_CON1},
	{"EFUSE_CON2", EFUSE_CON2},
	{"EFUSE_CON3", EFUSE_CON3},
	{"EFUSE_CON4", EFUSE_CON4},
	{"EFUSE_CON5", EFUSE_CON5},
	{"EFUSE_CON6", EFUSE_CON6},
	{"EFUSE_VAL_0_15", EFUSE_VAL_0_15},
	{"EFUSE_VAL_16_31", EFUSE_VAL_16_31},
	{"EFUSE_VAL_32_47", EFUSE_VAL_32_47},
	{"EFUSE_VAL_48_63", EFUSE_VAL_48_63},
	{"EFUSE_VAL_64_79", EFUSE_VAL_64_79},
	{"EFUSE_VAL_80_95", EFUSE_VAL_80_95},
	{"EFUSE_VAL_96_111", EFUSE_VAL_96_111},
	{"EFUSE_VAL_112_127", EFUSE_VAL_112_127},
	{"EFUSE_VAL_128_143", EFUSE_VAL_128_143},
	{"EFUSE_VAL_144_159", EFUSE_VAL_144_159},
	{"EFUSE_VAL_160_175", EFUSE_VAL_160_175},
	{"EFUSE_VAL_176_191", EFUSE_VAL_176_191},
	{"EFUSE_DOUT_0_15", EFUSE_DOUT_0_15},
	{"EFUSE_DOUT_16_31", EFUSE_DOUT_16_31},
	{"EFUSE_DOUT_32_47", EFUSE_DOUT_32_47},
	{"EFUSE_DOUT_48_63", EFUSE_DOUT_48_63},
	{"EFUSE_DOUT_64_79", EFUSE_DOUT_64_79},
	{"EFUSE_DOUT_80_95", EFUSE_DOUT_80_95},
	{"EFUSE_DOUT_96_111", EFUSE_DOUT_96_111},
	{"EFUSE_DOUT_112_127", EFUSE_DOUT_112_127},
	{"EFUSE_DOUT_128_143", EFUSE_DOUT_128_143},
	{"EFUSE_DOUT_144_159", EFUSE_DOUT_144_159},
	{"EFUSE_DOUT_160_175", EFUSE_DOUT_160_175},
	{"EFUSE_DOUT_176_191", EFUSE_DOUT_176_191},
	{"EFUSE_CON7", EFUSE_CON7},
	{"EFUSE_CON8", EFUSE_CON8},
	{"EFUSE_CON9", EFUSE_CON9},
	{"RTC_MIX_CON0", RTC_MIX_CON0},
	{"RTC_MIX_CON1", RTC_MIX_CON1},
	{"AUDTOP_CON0", AUDTOP_CON0},
	{"AUDTOP_CON1", AUDTOP_CON1},
	{"AUDTOP_CON2", AUDTOP_CON2},
	{"AUDTOP_CON3", AUDTOP_CON3},
	{"AUDTOP_CON4", AUDTOP_CON4},
	{"AUDTOP_CON5", AUDTOP_CON5},
	{"AUDTOP_CON6", AUDTOP_CON6},
	{"AUDTOP_CON7", AUDTOP_CON7},
	{"AUDTOP_CON8", AUDTOP_CON8},
	{"AUDTOP_CON9", AUDTOP_CON9},
	{"AUXADC_ADC0", AUXADC_ADC0},
	{"AUXADC_ADC1", AUXADC_ADC1},
	{"AUXADC_ADC2", AUXADC_ADC2},
	{"AUXADC_ADC3", AUXADC_ADC3},
	{"AUXADC_ADC4", AUXADC_ADC4},
	{"AUXADC_ADC5", AUXADC_ADC5},
	{"AUXADC_ADC6", AUXADC_ADC6},
	{"AUXADC_ADC7", AUXADC_ADC7},
	{"AUXADC_ADC8", AUXADC_ADC8},
	{"AUXADC_ADC9", AUXADC_ADC9},
	{"AUXADC_ADC10", AUXADC_ADC10},
	{"AUXADC_ADC11", AUXADC_ADC11},
	{"AUXADC_ADC12", AUXADC_ADC12},
	{"AUXADC_ADC13", AUXADC_ADC13},
	{"AUXADC_ADC14", AUXADC_ADC14},
	{"AUXADC_ADC15", AUXADC_ADC15},
	{"AUXADC_ADC16", AUXADC_ADC16},
	{"AUXADC_ADC17", AUXADC_ADC17},
	{"AUXADC_ADC18", AUXADC_ADC18},
	{"AUXADC_ADC19", AUXADC_ADC19},
	{"AUXADC_ADC20", AUXADC_ADC20},
	{"AUXADC_RSV1", AUXADC_RSV1},
	{"AUXADC_RSV2", AUXADC_RSV2},
	{"AUXADC_CON0", AUXADC_CON0},
	{"AUXADC_CON1", AUXADC_CON1},
	{"AUXADC_CON2", AUXADC_CON2},
	{"AUXADC_CON3", AUXADC_CON3},
	{"AUXADC_CON4", AUXADC_CON4},
	{"AUXADC_CON5", AUXADC_CON5},
	{"AUXADC_CON6", AUXADC_CON6},
	{"AUXADC_CON7", AUXADC_CON7},
	{"AUXADC_CON8", AUXADC_CON8},
	{"AUXADC_CON9", AUXADC_CON9},
	{"AUXADC_CON10", AUXADC_CON10},
	{"AUXADC_CON11", AUXADC_CON11},
	{"AUXADC_CON12", AUXADC_CON12},
	{"AUXADC_CON13", AUXADC_CON13},
	{"AUXADC_CON14", AUXADC_CON14},
	{"AUXADC_CON15", AUXADC_CON15},
	{"AUXADC_CON16", AUXADC_CON16},
	{"AUXADC_CON17", AUXADC_CON17},
	{"AUXADC_CON18", AUXADC_CON18},
	{"AUXADC_CON19", AUXADC_CON19},
	{"AUXADC_CON20", AUXADC_CON20},
	{"AUXADC_CON21", AUXADC_CON21},
	{"AUXADC_CON22", AUXADC_CON22},
	{"AUXADC_CON23", AUXADC_CON23},
	{"AUXADC_CON24", AUXADC_CON24},
	{"AUXADC_CON25", AUXADC_CON25},
	{"AUXADC_CON26", AUXADC_CON26},
	{"AUXADC_CON27", AUXADC_CON27},
	{"ACCDET_CON0", ACCDET_CON0},
	{"ACCDET_CON1", ACCDET_CON1},
	{"ACCDET_CON2", ACCDET_CON2},
	{"ACCDET_CON3", ACCDET_CON3},
	{"ACCDET_CON4", ACCDET_CON4},
	{"ACCDET_CON5", ACCDET_CON5},
	{"ACCDET_CON6", ACCDET_CON6},
	{"ACCDET_CON7", ACCDET_CON7},
	{"ACCDET_CON8", ACCDET_CON8},
	{"ACCDET_CON9", ACCDET_CON9},
	{"ACCDET_CON10", ACCDET_CON10},
	{"ACCDET_CON11", ACCDET_CON11},
	{"ACCDET_CON12", ACCDET_CON12},
	{"ACCDET_CON13", ACCDET_CON13},
	{"ACCDET_CON14", ACCDET_CON14},
	{"ACCDET_CON15", ACCDET_CON15},
	{"ACCDET_CON16", ACCDET_CON16},
	{"RTC_BBPU", RTC_BBPU},
	{"RTC_IRQ_STA", RTC_IRQ_STA},
	{"RTC_IRQ_EN", RTC_IRQ_EN},
	{"RTC_CII_EN", RTC_CII_EN},
	{"RTC_AL_MASK", RTC_AL_MASK},
	{"RTC_TC_SEC", RTC_TC_SEC},
	{"RTC_TC_MIN", RTC_TC_MIN},
	{"RTC_TC_HOU", RTC_TC_HOU},
	{"RTC_TC_DOM", RTC_TC_DOM},
	{"RTC_TC_DOW", RTC_TC_DOW},
	{"RTC_TC_MTH", RTC_TC_MTH},
	{"RTC_TC_YEA", RTC_TC_YEA},
	{"RTC_AL_SEC", RTC_AL_SEC},
	{"RTC_AL_MIN", RTC_AL_MIN},
	{"RTC_AL_HOU", RTC_AL_HOU},
	{"RTC_AL_DOM", RTC_AL_DOM},
	{"RTC_AL_DOW", RTC_AL_DOW},
	{"RTC_AL_MTH", RTC_AL_MTH},
	{"RTC_AL_YEA", RTC_AL_YEA},
	{"RTC_OSC32CON", RTC_OSC32CON},
	{"RTC_POWERKEY1", RTC_POWERKEY1},
	{"RTC_POWERKEY2", RTC_POWERKEY2},
	{"RTC_PDN1", RTC_PDN1},
	{"RTC_PDN2", RTC_PDN2},
	{"RTC_SPAR0", RTC_SPAR0},
	{"RTC_SPAR1", RTC_SPAR1},
...
static int mt6323_regmon_write_reg(
	void         * private_data,
	unsigned int   address,
	unsigned int   value
);

static int mt6323_regmon_read_reg(
	void         * private_data,
	unsigned int   address,
	unsigned int * value
);

static regmon_customer_info_t mt6323_customer_info =
{
	.name           = "mt6323",
	.reg_info       = mt6323_regmon_reg_info,
	.reg_info_count = sizeof(mt6323_regmon_reg_info)/sizeof(mt6323_regmon_reg_info[0]),
	.write_reg      = mt6323_regmon_write_reg,
	.read_reg       = mt6323_regmon_read_reg,
	.private_data   = NULL,
};
...
//==============================================================================
#if (!defined(CONFIG_ARCH_MT8590_ICX))
/* MTK reference source code. */
int PMIC_IMM_GetOneChannelValue(int dwChannel, int deCount, int trimd)
#else /* (!defined(CONFIG_ARCH_MT8590_ICX)) */
/* SONY sound platform. */
/* Read PMIC GPADC read API (MTK API compatible). */
int PMIC_IMM_GetOneChannelValue(int dwChannel, int deCount, int trimd)
{	int		result;
	uint32_t	dummy;

	dummy = 0;
	result = PMIC_IMM_GetOneChannelValueRaw(dwChannel, deCount, trimd, &dummy);
	return	result;
}
/* Read PMIC GPADC read API (SONY extended API). */
int PMIC_IMM_GetOneChannelValueRaw(int dwChannel, int deCount, int trimd, uint32_t *raw)
#endif /* (!defined(CONFIG_ARCH_MT8590_ICX)) */
{
...
#if (defined(CONFIG_ARCH_MT8590_ICX))
/* SONY sound platform code. */
	*raw = (/* force_cast */ uint32_t)u4channel;
#endif /* (defined(CONFIG_ARCH_MT8590_ICX)) */
    /* Value averaging  */ 
...
#if (defined(CONFIG_ARCH_MT8590_ICX))
/* ICX platform specific code. */
/*==============================================================================
// PMIC-AUXADC without wake lock
// @pre Call this function only from boot before state running, suspend and resume procedures.
// @note intentionally reformat from MTK code to avoid merge conflict.
//==============================================================================
*/
int PMIC_IMM_GetOneChannelValue_wo_wake_lock(int dwChannel, int deCount, int trimd, uint32_t *raw)
{
	kal_int32	ret_data;
	kal_int32	count = 0;
	kal_int32	u4Sample_times = 0;
	...
	*raw = 0;
	...
	/* Caution: Channel numbers are re-mapped from HW register index.
		0 : BATON2 **
		1 : CH6
		2 : THR SENSE2 **
		3 : THR SENSE1
...
#if defined(CONFIG_MTK_SMART_BATTERY) && !defined(CONFIG_USB_GADGET_NO_VBUS_DETECT)
    do_chrdet_int_task();
#endif
...
void dct_pmic_VPA_sel(kal_uint32 volt)
{
    ...
    if(volt == VOL_DEFAULT)     { upmu_set_vpa_vosel(40);}
    else if(volt == VOL_2200){ upmu_set_vpa_vosel(34);}
    else if(volt == VOL_2500){ upmu_set_vpa_vosel(40);}
    else{
...
static ssize_t store_BUCK_VPROC_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	kal_uint32 val = simple_strtoul(buf,NULL,16);

    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set BUCK_VPROC_STATUS : %d\n",val);

		dct_pmic_VPROC_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
...
static ssize_t store_BUCK_VSYS_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set BUCK_VSYS_STATUS : %d\n",val);

		dct_pmic_VSYS_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_BUCK_VPA_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set BUCK_VPA_STATUS : %d\n",val);

		dct_pmic_VPA_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VTCXO_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VTCXO_STATUS : %d\n",val);

		dct_pmic_VTCXO_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VA_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VA_STATUS : %d\n",val);

		dct_pmic_VA_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VCAMA_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VCAMA_STATUS : %d\n",val);

		dct_pmic_VCAMA_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VCN28_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VCN28_STATUS : %d\n",val);

		dct_pmic_VCN28_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
#ifdef CONFIG_ARCH_MT8590_ICX
static ssize_t show_LDO_VCN33_BT_STATUS(struct device *dev,struct device_attribute *attr, char *buf)
{
    kal_uint32 ret_value=0;
    ...
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] LDO_VCN33_BT_STATUS : %d\n", ret_value);
    return sprintf(buf, "%u\n", ret_value);
}
static ssize_t store_LDO_VCN33_BT_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    if(buf != NULL && size != 0)
    {
    	kal_uint32 val = simple_strtoul(buf,NULL,16);

    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VCN33_BT_STATUS : %d\n",val);

		dct_pmic_VCN33_enable_bt((val) ? KAL_TRUE : KAL_FALSE);
    }
    return size;
}
static DEVICE_ATTR(LDO_VCN33_BT_STATUS, 0664, show_LDO_VCN33_BT_STATUS, store_LDO_VCN33_BT_STATUS);


static ssize_t show_LDO_VCN33_WIFI_STATUS(struct device *dev,struct device_attribute *attr, char *buf)
{
    kal_uint32 ret_value=0;
    ...
    ret = pmic_read_interface(reg_address, &reg_val, 0x01, 12);
    ret_value = reg_val;
    
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] LDO_VCN33_WIFI_STATUS : %d\n", ret_value);
    return sprintf(buf, "%u\n", ret_value);
}
static ssize_t store_LDO_VCN33_WIFI_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    if(buf != NULL && size != 0)
    {
    	kal_uint32 val = simple_strtoul(buf,NULL,16);

    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VCN33_WIFI_STATUS : %d\n",val);

		dct_pmic_VCN33_enable_wifi((val) ? KAL_TRUE : KAL_FALSE);
    }
    return size;
}
static DEVICE_ATTR(LDO_VCN33_WIFI_STATUS, 0664, show_LDO_VCN33_WIFI_STATUS, store_LDO_VCN33_WIFI_STATUS);
#endif
...
static ssize_t store_LDO_VIO28_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VIO28_STATUS : %d\n",val);

		dct_pmic_VIO28_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VUSB_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VUSB_STATUS : %d\n",val);

		dct_pmic_VUSB_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VMC_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VMC_STATUS : %d\n",val);

		dct_pmic_VMC_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VMCH_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VMCH_STATUS : %d\n",val);

		dct_pmic_VMCH_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VEMC_3V3_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VEMC_3V3_STATUS : %d\n",val);

		dct_pmic_VEMC_3V3_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VGP1_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VGP1_STATUS : %d\n",val);

		dct_pmic_VGP1_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VGP2_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VGP2_STATUS : %d\n",val);

		dct_pmic_VGP2_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VGP3_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VGP3_STATUS : %d\n",val);

		dct_pmic_VGP3_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VCN_1V8_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VCN_1V8_STATUS : %d\n",val);

		dct_pmic_VCN_1V8_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VSIM1_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VSIM1_STATUS : %d\n",val);

		dct_pmic_VSIM1_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VSIM2_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VSIM2_STATUS : %d\n",val);

		dct_pmic_VSIM2_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VRTC_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VRTC_STATUS : %d\n",val);

		dct_pmic_VRTC_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VCAM_AF_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VCAM_AF_STATUS : %d\n",val);

		dct_pmic_VCAM_AF_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VIBR_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VIBR_STATUS : %d\n",val);

		dct_pmic_VIBR_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VM_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VM_STATUS : %d\n",val);

		dct_pmic_VM_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VRF18_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VRF18_STATUS : %d\n",val);

		dct_pmic_VRF18_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VIO18_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VIO18_STATUS : %d\n",val);

		dct_pmic_VIO18_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VCAMD_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VCAMD_STATUS : %d\n",val);

		dct_pmic_VCAMD_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
static ssize_t store_LDO_VCAM_IO_STATUS(struct device *dev,struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if(buf != NULL && size != 0)
    {
    	...
    	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[EM] Set LCO_VCAM_IO_STATUS : %d\n",val);

		dct_pmic_VCAM_IO_enable((val) ? KAL_TRUE : KAL_FALSE);
    }
#else
    xlog_printk(ANDROID_LOG_DEBUG, "Power/PMIC", "[EM] Not Support Write Function\n");    
#endif
...
#define MT6323_AUXADC_CHANNEL_MAX		(16)
#define	MT6323_AUXADC_CHANNEL_STRING_MAX	(1+3*sizeof(int)+1)
static ssize_t mt6323_auxadc_show(struct device *dev,struct device_attribute *attr, char *buf)
{	const size_t	len_max = PAGE_SIZE - (2 /* EndOfLine + NulTerminator */);
	size_t		len;
	char		*p;
	int		mv;
	int		i;
	...
	i = 0;
	len = len_max;
	while (len > MT6323_AUXADC_CHANNEL_STRING_MAX + (1 /* Comma */)) {
		size_t	ch_read_len;
		mv = PMIC_IMM_GetOneChannelValue(i, 1, 1);
		ch_read_len = snprintf(p, MT6323_AUXADC_CHANNEL_STRING_MAX, "%d", mv);
		p +=   ch_read_len;
		len -= ch_read_len;
		i++; /* Step next channel. */
		if (i <= MT6323_AUXADC_CHANNEL_MAX) {
			/* Valid channel. */
			*p=','; /* Comma */
			p++;
			len--;
...
static DEVICE_ATTR(auxadc, S_IRUGO, mt6323_auxadc_show, NULL);
...
void pmic_ldo_enable(MT65XX_POWER powerId, kal_bool powerEnable)
{
    ...
    else if(powerId == MT6323_POWER_BUCK_VPA)      { dct_pmic_VPA_enable(powerEnable); }
    else
    {
...
void pmic_ldo_vol_sel(MT65XX_POWER powerId, MT65XX_POWER_VOLTAGE powerVolt)
{
    ...
    else if(powerId == MT6323_POWER_BUCK_VPA)        { dct_pmic_VPA_sel(powerVolt); }
    else
    {
...
#ifdef CONFIG_MTK_PMIC_VCDT_HV_UP
...
#ifdef CONFIG_MTK_PMIC_EN_BATON_TDET
ret = pmic_config_interface(0xE,0x1,0x1,2); // [2:2]: BATON_TDET_EN; enable
#endif
...
{
#ifdef CONFIG_MTK_PMIC_VIO28_OFF
	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[PMIC_CUSTOM_SETTING_V1] Turn off VIO28_PMU for not use.\n");
	pmic_config_interface(DIGLDO_CON0, 0, 0x1, 14);
#endif
}

/* this commentout is temporary.
 * if enter low power mode, we cannot use external3.3V, etc and cannot output the sound of mtk daughter_board and bx8590p2_linux board.
 */
#if 0
void PMIC_LowPower_SETTING(void)
{
	/* due to no external PMIC, set EXT_PMIC_EN shutdown , required by low power module */
    pmic_config_interface(STRUP_CON9, 1, 0x1, 1);
}
#endif
...
static int mt6323_regmon_write_reg(
	...
	upmu_set_reg_value(address, value);
	return 0;
}
...
static DEFINE_SPINLOCK(hwrs_lock);

static int vtcxo_suspend(struct hwrs *hwrs)
{
	unsigned long flags;

	spin_lock_irqsave(&hwrs_lock, flags);
	if (hwrs->cnt)
		upmu_set_vtcxo_on_ctrl(0);
	spin_unlock_irqrestore(&hwrs_lock, flags);

	return 0;
}

static int vtcxo_resume(struct hwrs *hwrs)
{
	unsigned long flags;

	spin_lock_irqsave(&hwrs_lock, flags);
	if (hwrs->cnt)
		upmu_set_vtcxo_on_ctrl(1);
	spin_unlock_irqrestore(&hwrs_lock, flags);

	return 0;
}

static int ext_pmic_en_suspend(struct hwrs *hwrs)
{
	unsigned long flags;

	spin_lock_irqsave(&hwrs_lock, flags);
	if(!hwrs->cnt)
		upmu_set_strup_ext_pmic_sel(1);
	spin_unlock_irqrestore(&hwrs_lock, flags);

	return 0;
}

static int ext_pmic_en_resume(struct hwrs *hwrs)
{
	unsigned long flags;

	spin_lock_irqsave(&hwrs_lock, flags);
	if(!hwrs->cnt)
		upmu_set_strup_ext_pmic_sel(0);
	spin_unlock_irqrestore(&hwrs_lock, flags);

	return 0;
}

static struct hwrs_ops vtcxo_ops = {
	.suspend = vtcxo_suspend,
	.resume = vtcxo_resume,
};

static struct hwrs_ops ext_pmic_en_ops = {
	.suspend = ext_pmic_en_suspend,
	.resume = ext_pmic_en_resume,
};

static struct hwrs hwrs[NR_HWRS] = {
	[VOLT_VTCXO_PMU] = {
		.id = VOLT_VTCXO_PMU,
		.name = __stringify(VOLT_VTCXO_PMU),
		.ops = &vtcxo_ops,
	},
	[CTRL_EXT_PMIC_EN] = {
		.id = CTRL_EXT_PMIC_EN,
		.name = __stringify(CTRL_EXT_PMIC_EN),
		.ops = &ext_pmic_en_ops,
	},
};

void pmic_hwrs_claim(enum hwrs_id hwrs_id)
{
	unsigned long flags;
	BUG_ON((hwrs_id >= NR_HWRS));

	spin_lock_irqsave(&hwrs_lock, flags);
	hwrs[hwrs_id].cnt++;
	spin_unlock_irqrestore(&hwrs_lock, flags);
}
EXPORT_SYMBOL(pmic_hwrs_claim);

void pmic_hwrs_release(enum hwrs_id hwrs_id)
{
	unsigned long flags;
	BUG_ON((hwrs_id >= NR_HWRS));
	BUG_ON(!(hwrs[hwrs_id].cnt));

	spin_lock_irqsave(&hwrs_lock, flags);
	hwrs[hwrs_id].cnt--;
	spin_unlock_irqrestore(&hwrs_lock, flags);
}
EXPORT_SYMBOL(pmic_hwrs_release);
...
static int pmic_mt6323_probe(struct platform_device *dev)
{
    ...
    //PMIC_LowPower_SETTING();
    //xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[PMIC_LowPower_SETTING] Done\n");
    ...
    pmic_interrupt_thread = kthread_run(pmic_thread_kthread, NULL, "pmic_thread_kthread");
    if (IS_ERR(pmic_interrupt_thread)) {
        ret_val = PTR_ERR(pmic_interrupt_thread);
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "failed to create PMIC Interrupt thread: %d\n",ret_val);
    }
...
#if (defined(REGMON_DEBUG))
	regmon_del(&mt6323_customer_info);
#endif /* (defined(REGMON_DEBUG)) */

#if (defined(CONFIG_ARCH_MT8590_ICX))
	device_remove_file(&(dev->dev), &dev_attr_auxadc);
#endif /* (defined(CONFIG_ARCH_MT8590_ICX)) */
    return 0;
}
...
{
	pmic_thread_shutdown = true;

	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "******** MT6323 pmic driver shutdown!! ********\n" );

	mt_eint_mask(CUST_EINT_MT6323_PMIC_NUM);

	pmic_thread_timeout = 1;
	wake_up(&pmic_thread_wq);
	kthread_stop(pmic_interrupt_thread);
}
...
static int pmic_mt6323_suspend(struct platform_device *dev, pm_message_t state)
{
	...
	for (idx = 0; idx < NR_HWRS; idx++) {
		pr_err("suspend hwrs: %s, cnt: %d.\n", hwrs[idx].name,
					hwrs[idx].cnt);
		hwrs[idx].ops->suspend(&hwrs[idx]);
	}
...
static int pmic_mt6323_resume(struct platform_device *dev)
{
	...
	for (idx = 0; idx < NR_HWRS; idx++) {
		pr_err("resume hwrs: %s, cnt: %d.\n", hwrs[idx].name,
					hwrs[idx].cnt);
		hwrs[idx].ops->resume(&hwrs[idx]);
	}
...
#ifdef CONFIG_ARCH_MT8590_ICX
    ret_device_file = device_create_file(&(dev->dev), &dev_attr_LDO_VCN33_BT_STATUS);
    ret_device_file = device_create_file(&(dev->dev), &dev_attr_LDO_VCN33_WIFI_STATUS);
#endif
...
#if (defined(CONFIG_ARCH_MT8590_ICX))
	ret_device_file = device_create_file(&(dev->dev), &dev_attr_auxadc);
	if (ret_device_file != 0) {
		pr_err("%s: Can not create auxadc node. ret=%d\n", __func__, ret_device_file);
	}
#endif /* (defined(CONFIG_ARCH_MT8590_ICX)) */

#if (defined(REGMON_DEBUG))
	regmon_add(&mt6323_customer_info);
#endif /* (defined(REGMON_DEBUG)) */
    return 0;
}
...
#ifdef CONFIG_DISABLE_UNNECESSARY_LDO

#if 0
static void pmic_mt6323_show_ldo_state(void)
{
	const U32 addr[]={
		DIGLDO_CON7,
		DIGLDO_CON8,
	...
	const U32 mask[]={
		PMIC_RG_VGP1_EN_MASK,
		PMIC_RG_VGP2_EN_MASK,
		PMIC_RG_VGP3_EN_MASK,
		PMIC_RG_VCAM_IO_EN_MASK,
		PMIC_RG_VEMC_3V3_EN_MASK,
	};
	const U32 shift[]={
		PMIC_RG_VGP1_EN_SHIFT,
		PMIC_RG_VGP2_EN_SHIFT,
		PMIC_RG_VGP3_EN_SHIFT,
		PMIC_RG_VCAM_IO_EN_SHIFT,
		PMIC_RG_VEMC_3V3_EN_SHIFT,
	};
	const char * name[]={
		"VGP1",
		"VGP2",
	...
	for(n=0; n<sizeof(addr)/sizeof(U32); n++){

		rv=pmic_read_interface(addr[n],&val,mask[n],shift[n]);
		if(rv!=0){
			printk(KERN_ERR "%s(): pmic_read_interface(%s) failed.\n",__FUNCTION__,name[n]);
			break;
		}

		printk(KERN_ERR "LDO %s : %s\n",name[n],val?"on":"off");
	}
...
static int __init pmic_mt6323_init_late(void)
{
	int data[4] = { 0, 0, 0, 0 };
	int ad_val = 0;
	int ret = 0;
	...
	if(!ret && ad_val < ICX_AD_VAL_TH){
		/* SET */
		printk(KERN_INFO "power off unnecessary LDO.\n");
		upmu_set_rg_vgp1_en(0);
		upmu_set_rg_vgp2_en(0);
		upmu_set_rg_vgp3_en(0);
		upmu_set_rg_vcam_io_en(0);
...
#ifdef CONFIG_DISABLE_UNNECESSARY_LDO
late_initcall_sync(pmic_mt6323_init_late);
#endif
