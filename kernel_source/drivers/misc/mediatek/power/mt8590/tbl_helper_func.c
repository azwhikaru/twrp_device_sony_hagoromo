...
#ifdef CONFIG_MTK_BQ24195_SUPPORT
#include "bq24195.h"
#endif
...
void tbl_charger_otg_vbus(int mode)
{
    ...
    if(mode&0xFF)
    {
...
#ifdef CONFIG_MTK_BQ24195_SUPPORT
        bq24195_set_chg_config(0x3); //OTG
        bq24195_set_boostv(0x7); //boost voltage 4.998V
        bq24195_set_boost_lim(0x1); //1.5A on VBUS
		...
		bq25890_config_interface(bq25890_CON0, 0x3F, 0x3F, 0);	/* input current 3.25A*/
		bq25890_otg_en(0x1); //otg enable
#endif
    }
    else
    {
...
#ifdef CONFIG_MTK_BQ24195_SUPPORT
        bq24195_set_chg_config(0x0); //Charge disabled
#endif
