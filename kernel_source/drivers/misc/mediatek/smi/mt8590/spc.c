...
#define SPCMSG(string, args...)	pr_info("SPC", "[pid=%d]"string,current->tgid,##args)
#define SPCTMP(string, args...) pr_info("SPC", "[pid=%d]"string,current->tgid,##args)
#define SPCERR(string, args...) do{\
	pr_err("SPC", "error: "string, ##args); \
