...
static DEVICE_ATTR(spi,     S_IWUGO, NULL, spi_store);
static DEVICE_ATTR(spi_msg, S_IWUGO, NULL, spi_msg_store);
#else
...
static struct spi_board_info spi0_board_devs[] __initdata = {
	[0] = {
        	.modalias="spi-ut",
		.bus_num = 0,
		.chip_select=1,
...
static struct spi_board_info spi1_board_devs[] __initdata = {
	[0] = {
        	.modalias="spi-ut",
		.bus_num = 1,
		.chip_select=1,
...
static struct spi_board_info spi2_board_devs[] __initdata = {
	[0] = {
        	.modalias="spi-ut",
		.bus_num = 2,
		.chip_select=1,
...
static int __init spi_dev_init(void)
{
	...
	spi_register_board_info(spi0_board_devs, ARRAY_SIZE(spi0_board_devs));
	spi_register_board_info(spi1_board_devs, ARRAY_SIZE(spi1_board_devs));
	spi_register_board_info(spi2_board_devs, ARRAY_SIZE(spi2_board_devs));
