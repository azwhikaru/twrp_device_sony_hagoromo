...
/* Number of CPU CORE */
#if defined(CONFIG_ARCH_MT6589) || defined(CONFIG_ARCH_MT8590)
...
#elif defined(CONFIG_ARCH_MT6589) || defined(CONFIG_ARCH_MT8590)
...
int mtk_thermal_get_cpu_info(
    ...
    int **cpuloading)
{
#if defined(CONFIG_ARCH_MT6577) || defined(CONFIG_ARCH_MT6589) || defined(CONFIG_ARCH_MT8590)
    //******************
    // CPU Usage
    //******************
