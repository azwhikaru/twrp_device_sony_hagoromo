...
PMU_STATUS BAT_PreChargeModeAction(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[BATTERY] Pre-CC mode charge, timer=%ld on %ld !!\n\r",
...
PMU_STATUS BAT_ConstantCurrentModeAction(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[BATTERY] CC mode charge, timer=%ld on %ld !!\n\r",
...
PMU_STATUS BAT_TopOffModeAction(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[BATTERY] Top Off mode charge, timer=%ld on %ld !!\n\r",
