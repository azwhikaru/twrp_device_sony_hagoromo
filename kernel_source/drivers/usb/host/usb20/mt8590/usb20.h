...
#if defined(CONFIG_USB_MTK_OTG) && !defined(USB_SW_WITCH_MODE)
#ifdef ID_PIN_USE_EX_EINT
#ifdef CUST_EINT_USB_IDDIG_NUM
#define IDDIG_EINT_PIN (CUST_EINT_USB_IDDIG_NUM  & ~(0x80000000))
#else
#define IDDIG_EINT_PIN (122 & ~(0x80000000))
#endif
#else
#define U2PHYDTM1  (USB_SIF_BASE+0x800 + 0x6c)
#define ID_PULL_UP 0x0101
#define ID_PHY_RESET 0x3d11
#define U2FORCE_IDDIG 0x0113
#endif
#endif
...
#elif defined(CONFIG_MTK_NCP1851_SUPPORT) || defined(CONFIG_MTK_BQ24196_SUPPORT) || defined(CONFIG_MTK_BQ24296_SUPPORT) || defined(CONFIG_MTK_NCP1854_SUPPORT) || defined(CONFIG_MTK_BQ25890_SUPPORT)
