...
#if (!defined(CONFIG_MTK_USBFSH) && !defined(CONFIG_USB11_MTK_HDRC)) 
#include "../../usb11/mt8590/musbfsh_mt65xx.h"
#endif
...
void usb_phy_savecurrent(void){
	...
	printk("port0 usb_phy_savecurrent close port1 \n");	
	#endif
