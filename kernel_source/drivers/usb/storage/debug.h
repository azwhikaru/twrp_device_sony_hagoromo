...
#if (defined(CONFIG_ARCH_MT8590_ICX))
#define	USB_STOR_DEBUG_FLAG_PRINTK	(0x00000001)

extern uint usb_stor_debug_printk;
extern  int usb_stor_debug_printlv;
#endif /* (defined(CONFIG_ARCH_MT8590_ICX)) */
...
#define US_DEBUGPX(fmt, ...)	\
	do { \
		if (usb_stor_debug_printk & USB_STOR_DEBUG_FLAG_PRINTK) { \
