...
void mtk_uart_register_event_notifier( void (*notifier)( int type) );
#define MTK_UART_EVENT_TYPE_RD_ERR  (1) /* framing error, break condition */
#define MTK_UART_EVENT_TYPE_OPEN        (2) /* startup( open ) */
