...
#ifndef _MT8590_AFE_REG_H_
#define _MT8590_AFE_REG_H_

/* export to mt8590-afe.c only */
...
#define AUD_EXT1_K1_MASK   (0xFF<<0) /* bit[7:0] */
#define AUD_EXT2_K1_MASK   (0xFF<<8) /* bit[15:8] */
...
#define AUD_A1SYS_K1_OFF        (0x1<<21)
...
#define AFE_SPDIFIN_REAL_OPTICAL_MASK (0x1<<14)
...
/* Morning add for 8590 PCM intf test */
...
#define SPDIF_OUT_MEMIF_ON_OFF_MASK  (0x1 << 1)
#define SPDIF_OUT_MEMIF_ON       (0x1 << 1)
#define SPDIF_OUT_MEMIF_OFF      (0x0 << 1)


/* AFE_IEC_CFG */
#define IEC_RAW_SEL_MASK       (0x1 << 0)
#define IEC_RAW_SEL_COOK   (0x0 << 0)
#define IEC_RAW_SEL_RAW    (0x1 << 0)
#define IEC_PCM_SEL_MASK       (0x1 << 1)
#define IEC_PCM_SEL_PCM    (0x0 << 1)
#define IEC_PCM_SEL_ENC    (0x1 << 1)
#define IEC_MUTE_DATA_MASK     (0x1 << 3)
#define IEC_MUTE_DATA_NORMAL (0x0 << 3)
...
#define IEC_BURST_READY_MASK     (0x1 << 16)
#define IEC_BURST_READY_NOT_READY (0x1 << 16)

/* AFE_IEC_BURST_LEN */
#define IEC_BURST_LEN_MASK       0x7FFFF

/* AFE_SPDIF2_OUT_CON0 */
#define SPDIF2_OUT_CLOCK_ON_OFF_MASK  (0x1 << 0)
#define SPDIF2_OUT_CLOCK_ON       (0x1 << 0)
#define SPDIF2_OUT_CLOCK_OFF      (0x0 << 0)
#define SPDIF2_OUT_MEMIF_ON_OFF_MASK  (0x1 << 1)
#define SPDIF2_OUT_MEMIF_ON       (0x1 << 1)
#define SPDIF2_OUT_MEMIF_OFF      (0x0 << 1)
/* AFE_IEC2_NSNUM */
...
#define IEC2_BURST_READY_MASK     (0x1 << 16)
#define IEC2_BURST_READY_NOT_READY (0x1 << 16)
/* AFE_IEC2_BURST_LEN */
#define IEC2_BURST_LEN_MASK    0x7FFFF

/* AFE_IEC2_CFG */
#define IEC2_RAW_SEL_MASK         (0x1 << 0)
#define IEC2_RAW_SEL_COOK   (0x0 << 0)
#define IEC2_RAW_SEL_RAW    (0x1 << 0)
#define IEC2_PCM_SEL_MASK         (0x1<< 1)
#define IEC2_PCM_SEL_PCM    (0x0 << 1)
#define IEC2_PCM_SEL_ENC    (0x1 << 1)
#define IEC2_MUTE_DATA_MASK       (0x1 << 3)
#define IEC2_MUTE_DATA_NORMAL   (0x0<< 3)
...
#define IEC2_DISABLE_MASK            (0x1 << 16)
